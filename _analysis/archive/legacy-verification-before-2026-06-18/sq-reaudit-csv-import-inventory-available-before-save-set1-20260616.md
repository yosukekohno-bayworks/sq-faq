    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        ...
        - generic [ref=e250]:
          - generic [ref=e252]:
            - generic [ref=e255]:
              - heading "反映方法" [level=2] [ref=e256]
              - status [ref=e257]:
                - generic [ref=e260]:
                  - img [ref=e263]
                  - generic [ref=e270]: 現在の在庫数が10のとき、CSVで20を指定すると、絶対値で反映した場合の在庫数は20になります。差分値で反映した場合の在庫数は30になります。
              - group "反映方法" [ref=e271]:
                - generic [ref=e272]: 反映方法
                - list [ref=e273]:
                  - listitem [ref=e274]:
                    - generic [ref=e276] [cursor=pointer]:
                      - radio "絶対値で反映する" [checked] [ref=e279]
                      - generic [ref=e281]: 絶対値で反映する
                  - listitem [ref=e282]:
                    - generic [ref=e284] [cursor=pointer]:
                      - radio "差分値で反映する" [ref=e287]
                      - generic [ref=e289]: 差分値で反映する
            - generic [ref=e293]:
              - generic [ref=e294]:
                - img [ref=e297]
                - paragraph [ref=e299]: full_exec_inventory_available_set1.csv
              - button [ref=e300] [cursor=pointer]:
                - img [ref=e303]
          - button "保存する" [ref=e309] [cursor=pointer]:
            - generic [ref=e310]: 保存する
