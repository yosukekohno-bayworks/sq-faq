  ...
  - generic [ref=e16]:
    ...
    - main [ref=e234]:
      - generic [ref=e269]:
        - generic [ref=e270]:
          - status:
            - paragraph [ref=e271]: ポイントをCSVで一括減算する。このページの準備が整いました
          - generic [ref=e273]:
            - link [ref=e276] [cursor=pointer]:
              - /url: /admin/csv_import
              - img [ref=e279]
            - heading "ポイントをCSVで一括減算する" [level=1] [ref=e283]
            - generic [ref=e284]:
              - link "テンプレート" [ref=e289] [cursor=pointer]:
                - /url: https://docs.google.com/spreadsheets/d/1SzL37YFB8SQpU_a1Bk7lSuzvnV74WTT-Bme3WgAR3Uo
                - generic [ref=e290]: テンプレート
              - link "新規インポート" [ref=e293] [cursor=pointer]:
                - /url: /admin/csv_import/csv_import_operation_point_minuses/create
                - generic [ref=e294]: 新規インポート
        - generic [ref=e301]:
          - generic [ref=e303]:
            - img "空の検索結果" [ref=e305]
            - paragraph [ref=e307]: アイテムが見つかりませんでした
            - paragraph [ref=e310]: 絞り込みや検索ワードを変更してみてください
