  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: 会員ランク算出ルールを作成する。このページの準備が整いました
          - generic [ref=e238]:
            - link [ref=e241] [cursor=pointer]:
              - /url: /admin/customer_rank_calculation_rules
              - img [ref=e244]
            - heading "会員ランク算出ルールを作成する" [level=1] [ref=e248]
        - generic [ref=e250]:
          - generic [ref=e252]:
            - generic [ref=e254]:
              - generic [ref=e256]:
                - heading "ルール" [level=2] [ref=e257]
                - generic [ref=e258]:
                  - generic [ref=e260]:
                    - generic [ref=e263]: タイトル*
                    - textbox "タイトル*" [ref=e267]:
                      - /placeholder: タイトル
                  - group "算出方法" [ref=e269]:
                    - generic [ref=e270]: 算出方法
                    - list [ref=e271]
              - generic [ref=e288]:
                - separator [ref=e289]
                - generic [ref=e291] [cursor=pointer]:
                  - generic [ref=e293]:
                    - checkbox "税抜き価格でランクを算出する" [ref=e294]
                    - generic
                  - generic [ref=e296]: 税抜き価格でランクを算出する
            - generic [ref=e299]:
              - heading "算出期間" [level=2] [ref=e300]
              - generic [ref=e301]:
                - generic [ref=e304]: 期間
                - generic [ref=e305]:
                  - combobox "期間" [ref=e306]:
                    - option "1年間" [selected]
                    - option "直近365日"
                    - option "無期限"
                  - generic [ref=e307]:
                    - generic [ref=e308]: 1年間
                    - img [ref=e311]
              - generic [ref=e315]:
                - generic [ref=e318]: 開始月
                - generic [ref=e319]:
                  - combobox "開始月" [ref=e320]:
                    - option "1月" [selected]
                    - option "2月"
                    - option "3月"
                    - option "4月"
                  ...
                  - generic [ref=e321]:
                    - generic [ref=e322]: 1月
                    - img [ref=e325]
                - generic [ref=e329]: 開始月に4月を設定した場合、ランク算出期間の1年間は4月1日から3月31日となります
            - generic [ref=e332]:
              - heading "詳細" [level=2] [ref=e333]
              - generic [ref=e334]:
                - generic [ref=e336]:
                  - generic [ref=e337] [cursor=pointer]:
                    - generic [ref=e339]
                    - generic [ref=e342]: 会員ランクを月初に算出する
                  - generic [ref=e344]: この設定を有効にすることで顧客の会員ランクは毎月1日に再計算されます。
                - generic [ref=e346]:
                  - generic [ref=e347] [cursor=pointer]:
                    - generic [ref=e349]
                    - generic [ref=e352]: 会員ランクを次の算出期間に持ち越す
                  - generic [ref=e354]: 持ち越しを有効にすることで顧客は自分の会員ランクを最大2年間維持することができます。この設定は「開始月」が未選択、もしくは「会員ランクの反映を次の算出期間の開始日に行う」が有効の場合は利用できません。
          - button "保存する" [ref=e359] [cursor=pointer]:
            - generic [ref=e360]: 保存する
