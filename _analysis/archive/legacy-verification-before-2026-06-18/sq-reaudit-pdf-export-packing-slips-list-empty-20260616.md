  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: 納品書をPDFでエクスポートする。このページの準備が整いました
          - generic [ref=e238]:
            - link [ref=e241] [cursor=pointer]:
              - /url: /admin/pdf_export
              - img [ref=e244]
            - heading "納品書をPDFでエクスポートする" [level=1] [ref=e248]
        - generic [ref=e255]:
          - generic [ref=e257]:
            - img "空の検索結果" [ref=e259]
            - paragraph [ref=e261]: アイテムが見つかりませんでした
            - paragraph [ref=e264]: 絞り込みや検索ワードを変更してみてください
          - navigation "ページネーション" [ref=e266]:
            - generic [ref=e269]:
              - generic [ref=e270]:
                - button "前へ" [disabled]:
                  - generic:
