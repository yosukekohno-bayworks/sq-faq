  ...
  - generic [ref=e16]:
    ...
    - main [ref=e254]:
      - generic [ref=e257]:
        - generic [ref=e258]:
          - status:
            - paragraph [ref=e259]: 注文ポイント。このページの準備が整いました
          - generic [ref=e261]:
            - heading "注文ポイント" [level=1] [ref=e264]
            - link "付与ルールを作成する" [ref=e268] [cursor=pointer]:
              - /url: /admin/point_calculation_rules/create
              - generic [ref=e269]: 付与ルールを作成する
        - generic [ref=e274]:
          - tablist [ref=e279]:
          ...
          - table [ref=e287]:
            - rowgroup [ref=e288]:
              - row "すべてのアイテムを選択する ルール 利用テナント数" [ref=e289]:
                - columnheader "すべてのアイテムを選択する" [ref=e290]:
                  - generic [ref=e292] [cursor=pointer]:
                    - generic [ref=e294]:
                      - checkbox "すべてのアイテムを選択する" [ref=e295]
                      - generic:
                        - img
                    - generic [ref=e297]: すべてのアイテムを選択する
                - columnheader "ルール" [ref=e298]:
                  - generic [ref=e299]: ルール
                - columnheader "利用テナント数" [ref=e300]:
                  - generic [ref=e301]: 利用テナント数
            - rowgroup [ref=e302]:
              - row "アイテムを選択する TEST_FAQ_注文ポイント付与ルール 0件" [ref=e303] [cursor=pointer]:
                - cell "アイテムを選択する" [ref=e304]:
                  - generic [ref=e306]:
                    - generic [ref=e308]:
                      - checkbox "アイテムを選択する" [ref=e309]
                      - generic:
                        - img
                    - generic [ref=e311]: アイテムを選択する
                - cell "TEST_FAQ_注文ポイント付与ルール" [ref=e312]:
                  - paragraph [ref=e313]: TEST_FAQ_注文ポイント付与ルール
                - cell "0件" [ref=e314]:
                  - paragraph [ref=e315]: 0件
