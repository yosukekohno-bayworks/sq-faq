  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e311]:
        - generic [ref=e312]:
          - status:
            - paragraph [ref=e313]: 販売可能在庫をCSVでインポートする。このページの準備が整いました
          - generic [ref=e315]:
            - link [ref=e318] [cursor=pointer]:
              - /url: /admin/csv_import/csv_import_operation_inventory_logical_available_quantities
              - img [ref=e321]
            - heading "販売可能在庫をCSVでインポートする" [level=1] [ref=e325]
        - generic [ref=e327]:
          - generic [ref=e329]:
            - generic [ref=e332]:
              - heading "反映方法" [level=2] [ref=e333]
              - status [ref=e334]:
                - generic [ref=e337]:
                  - img [ref=e340]
                  - generic [ref=e347]: 現在の在庫数が10のとき、CSVで20を指定すると、絶対値で反映した場合の在庫数は20になります。差分値で反映した場合の在庫数は30になります。
              - group "反映方法" [ref=e348]:
                - generic [ref=e349]: 反映方法
                - list [ref=e350]:
                  - listitem [ref=e351]:
                    - generic [ref=e353] [cursor=pointer]:
                      - radio "絶対値で反映する" [checked] [ref=e356]
                      - generic [ref=e358]: 絶対値で反映する
                  - listitem [ref=e359]:
                    - generic [ref=e361] [cursor=pointer]:
                      - radio "差分値で反映する" [ref=e364]
                      - generic [ref=e366]: 差分値で反映する
            - generic [ref=e370]:
              - generic [ref=e373]: ファイルをアップロード
              - generic [ref=e374]:
                - button "ファイルをアップロード" [ref=e376]
                - generic [ref=e380]:
                  - button "ファイルを選択する" [ref=e381] [cursor=pointer]:
                    - generic [ref=e382]: ファイルを選択する
                  - paragraph [ref=e383]: もしくはドラッグ&ドロップでアップロードすることができます
          - button "保存する" [ref=e388] [cursor=pointer]:
            - generic [ref=e389]: 保存する
