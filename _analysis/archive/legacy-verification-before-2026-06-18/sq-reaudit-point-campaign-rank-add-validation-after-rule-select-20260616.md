  ...
  - generic [ref=e16]:
    ...
    - main [ref=e254]:
      - generic [ref=e257]:
        - generic [ref=e258]:
          - status:
            - paragraph [ref=e259]: 会員ランクのキャンペーン設定を追加する。このページの準備が整いました
          - generic [ref=e261]:
            - link [ref=e264] [cursor=pointer]:
              - /url: /admin/point_campaign_order_rules/3337d097-5031-5814-9da5-6d719c02dbe8_PointCampaignOrderRule/customer_ranks
              - img [ref=e267]
            - generic [ref=e269]:
              - heading "会員ランクのキャンペーン設定を追加する" [level=1] [ref=e271]
              - paragraph [ref=e273]: TEST_FAQ_ランク別ポイントキャンペーン
        - generic [ref=e275]:
          - generic [ref=e277]:
            - generic [ref=e280]:
              - heading "会員ランク" [level=3] [ref=e281]
              - generic [ref=e282]:
                - generic [ref=e284]:
                  - generic [ref=e287]: 会員ランク算出ルール*
                  - generic [ref=e288]:
                    - combobox "会員ランク算出ルール*" [ref=e289]
                    - generic [ref=e290]
                - generic [ref=e299]:
                  - generic [ref=e302]: 会員ランク*
                  - generic [ref=e303]:
                    - combobox "会員ランク*" [invalid] [ref=e304]
                    - generic [ref=e305]
                  - generic [ref=e338]:
                    - img [ref=e341]
                    - generic [ref=e345]: 会員ランクを選択してください
                  - generic [ref=e313]: 既に設定されている会員ランクは選択できません
            - generic [ref=e316]:
              - heading "ポイント" [level=3] [ref=e317]
              - generic [ref=e318]:
                - generic [ref=e321]: ポイント倍率*
                - generic [ref=e324]:
                  - generic [ref=e325]: 通常獲得ポイントに追加で
                  - spinbutton "ポイント倍率* 通常獲得ポイントに追加で 倍分のポイントを付与する" [invalid] [ref=e326]
                  - generic [ref=e327]: 倍分のポイントを付与する
                - generic [ref=e347]:
                  - img [ref=e350]
                  - generic [ref=e354]: ポイント倍率を入力してください
                - paragraph [ref=e330]:
                  - text: キャンペーン倍率は「通常ポイントに加えた合計倍率」として適用されます。
                  - text: 例）キャンペーン倍率に「3」と入力すると、通常倍率が2倍の会員ランクなら、通常2倍 + キャンペーン3倍 = 合計5倍 となります。
          - button "保存する" [ref=e335] [cursor=pointer]:
            - generic [ref=e336]: 保存する
