  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: 会員ランク。このページの準備が整いました
          - generic [ref=e238]:
            - heading "会員ランク" [level=1] [ref=e241]
            - link "会員ランク算出ルールを作成する" [ref=e245] [cursor=pointer]:
              - /url: /admin/customer_rank_calculation_rules/create
              - generic [ref=e246]: 会員ランク算出ルールを作成する
        - generic [ref=e251]:
          - tablist [ref=e256]:
            - tab "すべて" [selected] [ref=e257] [cursor=pointer]:
              - generic [ref=e259]: すべて
          - separator [ref=e260]
          - table [ref=e264]:
            - rowgroup [ref=e265]:
              - row "すべてのアイテムを選択する ルール 利用テナント数" [ref=e266]:
                - columnheader "すべてのアイテムを選択する" [ref=e267]:
                  - generic [ref=e269] [cursor=pointer]
                - columnheader "ルール" [ref=e275]:
                  - generic [ref=e276]: ルール
                - columnheader "利用テナント数" [ref=e277]:
                  - generic [ref=e278]: 利用テナント数
            - rowgroup [ref=e279]:
              - row "アイテムを選択する TEST_FAQ_会員ランク算出ルール 0件" [ref=e280] [cursor=pointer]:
                - cell "アイテムを選択する" [ref=e281]:
                  - generic [ref=e283]
                - cell "TEST_FAQ_会員ランク算出ルール" [ref=e289]:
                  - paragraph [ref=e290]: TEST_FAQ_会員ランク算出ルール
                - cell "0件" [ref=e291]:
                  - paragraph [ref=e292]: 0件
              - row "アイテムを選択する TEST_FAQ_RANK_20260615081841 0件" [ref=e293] [cursor=pointer]:
                - cell "アイテムを選択する" [ref=e294]:
                  - generic [ref=e296]
                - cell "TEST_FAQ_RANK_20260615081841" [ref=e302]:
                  - paragraph [ref=e303]: TEST_FAQ_RANK_20260615081841
                - cell "0件" [ref=e304]:
                  - paragraph [ref=e305]: 0件
