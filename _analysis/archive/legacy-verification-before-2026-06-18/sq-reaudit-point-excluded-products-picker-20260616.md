  ...
  - generic [ref=e16]:
    ...
    - main [ref=e254]:
      - generic [ref=e257]:
        - generic [ref=e258]:
          - status:
            - paragraph [ref=e259]: 利用外商品を追加する。このページの準備が整いました
          - generic [ref=e261]:
            - link [ref=e264] [cursor=pointer]:
              - /url: /admin/point_application_excluded_products
              - img [ref=e267]
            - heading "利用外商品を追加する" [level=1] [ref=e271]
        - generic [ref=e273]:
          - generic [ref=e279]:
            - generic [ref=e282]: 商品を選択する*
            - generic [ref=e283]:
              - textbox "商品を選択する*" [ref=e286]:
                - /placeholder: 選択してください
              - button "選択" [ref=e288] [cursor=pointer]:
                - generic [ref=e289]: 選択
          - button "保存する" [ref=e294] [cursor=pointer]:
            - generic [ref=e295]: 保存する
        ...
        - generic:
          - generic:
            - dialog "商品を選択する":
              - generic [ref=e296]:
                - generic [ref=e298]:
                  - heading "商品を選択する" [level=2] [ref=e300]
                  - button "閉じる" [ref=e301] [cursor=pointer]:
                    - img [ref=e304]
                - generic [ref=e306]:
                  - generic [ref=e316]:
                    - generic [ref=e319]: 商品コードで検索する
                    - generic [ref=e322]
                  - generic [ref=e330]:
                    - table [ref=e332]
                    - navigation "ページネーション" [ref=e507]
                - generic [ref=e516]:
                  - button "キャンセル" [ref=e517] [cursor=pointer]:
                    - generic [ref=e518]: キャンセル
                  - button "選択する" [ref=e519] [cursor=pointer]:
                    - generic [ref=e520]: 選択する
  - alert [ref=e15]