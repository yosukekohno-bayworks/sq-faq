  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: 売上実績（明細軸）をCSVでエクスポートする。このページの準備が整いました
          - generic [ref=e238]:
            - link [ref=e241] [cursor=pointer]:
              - /url: /admin/csv_export/csv_export_operation_sale_change_line_items
              - img [ref=e244]
            - heading "売上実績（明細軸）をCSVでエクスポートする" [level=1] [ref=e248]
        - generic [ref=e250]:
          - generic [ref=e254]:
            - generic [ref=e256]:
              - generic [ref=e259]: テナント*
              - generic [ref=e260]:
                - combobox "テナント*" [ref=e261]:
                  - option "選択してください" [disabled]
                  - option "ユニクロ" [selected]
                  - option "TEST_FAQ_COVERAGE_20260615_テナント_EDIT"
                - generic [ref=e262]:
                  - generic [ref=e263]: ユニクロ
                  - img [ref=e266]
              - generic [ref=e270]: エクスポートするテナントを選択してください
            - group [ref=e271]:
              - generic [ref=e272]:
                - generic [ref=e274]:
                  - generic [ref=e277]: 開始日時*
                  - textbox "開始日時*" [ref=e281]: 2026-06-16T00:00
                  - generic [ref=e282]: 絞り込みを開始する日時を入力してください
                - generic [ref=e284]:
                  - generic [ref=e287]: 終了日時*
                  - textbox "終了日時*" [active] [ref=e291]: 2026-06-16T23:59
                  - generic [ref=e292]: 絞り込みを終了する日時を入力してください
          - button "エクスポートを開始する" [ref=e297] [cursor=pointer]:
            - generic [ref=e298]: エクスポートを開始する
