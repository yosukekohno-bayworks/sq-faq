  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        ...
        - generic [ref=e254]:
          - tablist [ref=e260]:
            - link "基本情報" [ref=e261] [cursor=pointer]:
              - /url: /admin/order_price_adjustment_rules/2c0e23bd-77df-5440-a291-2c8dfd057f45_OrderPriceAdjustmentRule
              - generic [ref=e263]: 基本情報
            - tab "利用履歴" [selected] [ref=e264] [cursor=pointer]:
          ...
          - generic [ref=e278]:
            - generic [ref=e280]:
              - heading "利用履歴" [level=2] [ref=e281]
              - link "CSVエクスポート" [ref=e282] [cursor=pointer]:
                - /url: /admin/csv_export/csv_export_operation_order_price_adjustment_usages
                - generic [ref=e283]: CSVエクスポート
            - separator [ref=e284]
            - generic [ref=e286]:
              - generic [ref=e288]:
                - img "空の検索結果" [ref=e290]
                - paragraph [ref=e292]: アイテムが見つかりませんでした
                - paragraph [ref=e295]: 絞り込みや検索ワードを変更してみてください
              - navigation "ページネーション" [ref=e297]:
                - generic [ref=e300]:
                  - generic [ref=e301]:
                    - button "前へ" [disabled]:
                      - generic:
