        ...
        - generic:
          - generic:
            - dialog "ロケーションを選択する" [active]:
              - generic [ref=e314]:
                - generic [ref=e316]:
                  - heading "ロケーションを選択する" [level=2] [ref=e318]
                  - button "閉じる" [ref=e319] [cursor=pointer]:
                    - img [ref=e322]
                - generic [ref=e324]:
                  - generic [ref=e330]:
                    - tablist [ref=e337]:
                      - tab "すべて" [selected] [ref=e338] [cursor=pointer]:
                        - generic [ref=e340]: すべて
                      - tab "店舗" [ref=e341] [cursor=pointer]:
                        - generic [ref=e343]: 店舗
                      - tab "倉庫" [ref=e344] [cursor=pointer]:
                        - generic [ref=e346]: 倉庫
                    - generic [ref=e347]:
                      - button "検索と絞り込みの結果" [ref=e350] [cursor=pointer]:
                        - generic [ref=e352]
                      - button "検索結果を並べ替える" [ref=e363] [cursor=pointer]:
                        - img [ref=e366]
                  - generic [ref=e370]:
                    - table [ref=e372]:
                      - rowgroup [ref=e373]:
                        - row "すべてのアイテムを選択する 名前 場所コード" [ref=e374]
                      - rowgroup [ref=e387]:
                        - row "アイテムを選択する 物流倉庫 W0001" [ref=e388] [cursor=pointer]
                        - row "アイテムを選択する ユニクロ - 銀座店 R0001" [ref=e401] [cursor=pointer]
                        - row "アイテムを選択する TEST_FAQ_DEEP2_202606080343_ロケーション test_faq_deep2_202606080343_loc" [ref=e414] [cursor=pointer]
                        - row "アイテムを選択する TEST_FAQ_店舗在庫EC販売用 TESTEC01" [ref=e427] [cursor=pointer]
                        - row "アイテムを選択する TEST_FAQ_COVERAGE_20260615_403698_ロケーション TFCLOC3698" [ref=e440] [cursor=pointer]
                        - row "アイテムを選択する Test1 12456789098765" [ref=e453] [cursor=pointer]
                    - navigation "ページネーション" [ref=e469]:
                      - generic [ref=e472]:
                        - generic [ref=e473]
                        - generic [ref=e474]
                - generic [ref=e478]:
                  - button "キャンセル" [ref=e479] [cursor=pointer]:
                    - generic [ref=e480]: キャンセル
                  - button "選択する" [ref=e481] [cursor=pointer]:
                    - generic [ref=e482]: 選択する
  - alert [ref=e15]