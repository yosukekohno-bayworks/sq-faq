  ...
  - generic [ref=e16]:
    ...
    - main [ref=e254]:
      - generic [ref=e257]:
        - generic [ref=e258]:
          - status:
            - paragraph [ref=e259]: 販売上限。このページの準備が整いました
          - generic [ref=e261]:
            - heading "販売上限" [level=1] [ref=e264]
            - link "販売上限ルールを作成する" [ref=e268] [cursor=pointer]:
              - /url: /admin/inventory_sale_limit_rules/create
              - generic [ref=e269]: 販売上限ルールを作成する
        - generic [ref=e276]:
          - generic [ref=e278]:
            - img "空の検索結果" [ref=e280]
            - paragraph [ref=e282]: アイテムが見つかりませんでした
            - paragraph [ref=e285]: 絞り込みや検索ワードを変更してみてください
          - navigation "ページネーション" [ref=e287]:
            - generic [ref=e290]:
              - generic [ref=e291]:
                - button "前へ" [disabled]
              - generic [ref=e292]:
