  ...
  - generic [ref=e16] [box=0,0,1600,1000]:
    ...
    - main [ref=e244] [box=0,0,1600,1000]:
      - generic [ref=e424] [box=421,56,998,163]:
        ...
        - generic [ref=e452] [box=445,150,950,69]:
          - generic [ref=e599] [box=457,156,930,24]:
            - generic [ref=e601] [cursor=pointer] [box=457,159,96,18]:
              - generic [box=457,159,18,18]:
                - generic [box=457,159,18,18]:
                  - generic [box=457,159,18,18]:
                    - generic [box=458,160,16,16]
                  - generic [box=457,150,1,1]: アイテムの選択を解除する
              - generic [ref=e603] [box=488,160,65,16]: 1を選択済み
            - button "ルールを削除する" [ref=e609] [cursor=pointer] [box=1275,156,112,24]:
              - generic [ref=e610] [box=1283,160,96,16]: ルールを削除する
      ...
      - generic [box=0,1000,1600,0]:
        - generic [box=0,0,1600,1000]:
          - generic [box=0,417,1600,166]:
            - dialog "カタログのルールを削除しますか？" [active] [box=0,417,1600,166]:
              - generic [ref=e611] [box=490,417,620,166]:
                - generic [ref=e613] [box=506,433,588,20]:
                  - heading "カタログのルールを削除しますか？" [level=2] [ref=e615] [box=506,433,224,20]
                  - button "閉じる" [ref=e616] [cursor=pointer] [box=1070,429,28,28]:
                    - img [ref=e619] [box=1074,433,20,20]
                - paragraph [ref=e624] [box=506,486,588,20]: 選択された1件のルールを削除します。この処理は巻き戻すことができません。
                - generic [ref=e628] [box=930,539,164,28]:
                  - button "キャンセル" [ref=e629] [cursor=pointer] [box=930,539,84,28]:
                    - generic [ref=e630] [box=942,545,60,16]: キャンセル
                  - button "削除する" [ref=e631] [cursor=pointer] [box=1022,539,72,28]:
                    - generic [ref=e632] [box=1034,545,48,16]: 削除する
