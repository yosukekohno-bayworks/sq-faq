  ...
  - generic [ref=e16]:
    ...
    - main [ref=e244]:
      - generic [ref=e476]:
        - generic [ref=e477]:
          - status:
            - paragraph [ref=e478]: 自動追加ルール。このページの準備が整いました
          - generic [ref=e480]:
            - link [ref=e483] [cursor=pointer]:
              - /url: /admin/catalogs/e2a819ab-3f81-558d-ad76-5fae9e8422d2_Catalog
              - img [ref=e486]
            - generic [ref=e488]:
              - heading "自動追加ルール" [level=1] [ref=e490]
              - paragraph [ref=e492]: TEST_FAQ_カタログ001
            - button "追加する" [ref=e496] [cursor=pointer]:
              - generic [ref=e497]: 追加する
        - generic [ref=e506]:
          - img "空の検索結果" [ref=e508]
          - paragraph [ref=e510]: アイテムが見つかりませんでした
          - paragraph [ref=e513]: 絞り込みや検索ワードを変更してみてください
  ...
  - generic:
    - generic:
      - generic:
        - generic:
          - generic:
            - dialog "ルールを追加する" [active]:
              - generic [ref=e514]:
                - generic [ref=e516]:
                  - heading "ルールを追加する" [level=2] [ref=e518]
                  - button "閉じる" [ref=e519] [cursor=pointer]:
                    - img [ref=e522]
                - generic [ref=e527]:
                  - generic [ref=e529]:
                    - generic [ref=e532]: 項目
                    - generic [ref=e533]:
                      - combobox "項目" [ref=e534]:
                        - option "選択してください" [disabled] [selected]
                        - option "製造元"
                        - option "ブランドコード"
                      - generic [ref=e535]:
                        - generic [ref=e536]: 選択してください
                        - img [ref=e539]
                  - generic [ref=e544]:
                    - generic [ref=e547]: 条件
                    - generic [ref=e548]:
                      - combobox "条件" [ref=e549]:
                        - option "選択してください" [disabled] [selected]
                        - option "一致する"
                      - generic [ref=e550]:
                        - generic [ref=e551]: 選択してください
                        - img [ref=e554]
                  - generic [ref=e559]:
                    - generic [ref=e562]: 値
                    - textbox "値" [ref=e566]:
                      - /placeholder: ""
                - generic [ref=e570]:
                  - button "キャンセル" [ref=e571] [cursor=pointer]:
                    - generic [ref=e572]: キャンセル
                  - button "追加する" [ref=e573] [cursor=pointer]:
                    - generic [ref=e574]: 追加する
  - alert [ref=e15]