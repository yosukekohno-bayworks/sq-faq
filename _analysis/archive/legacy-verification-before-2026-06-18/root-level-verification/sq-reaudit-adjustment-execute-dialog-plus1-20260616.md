        ...
        - generic [ref=e2502]:
          ...
          - generic [ref=e2505]:
            ...
            - generic [ref=e2514]:
              ...
              - generic [ref=e2518]:
                - generic [ref=e2520]:
                  - generic [ref=e2521]: 注意 未完了
                  - img [ref=e2522]
                - generic [ref=e2524]: 未実施
            - generic [ref=e2525]:
              - button "キャンセル" [ref=e2530] [cursor=pointer]:
                - generic [ref=e2531]: キャンセル
              - button "実行" [ref=e2534] [cursor=pointer]:
                - generic [ref=e2535]: 実行
        - generic [ref=e2536]:
          - generic [ref=e2537]:
            - generic [ref=e2539]:
              - generic [ref=e2542]:
                ...
                - generic [ref=e2544]:
                  - generic [ref=e2547]: ロケーション
                  - generic [ref=e2548]:
                    - textbox "ロケーション" [ref=e2551]:
                      - /placeholder: ロケーションを選択してください
                      - text: 物流倉庫
                    - button "選択" [ref=e2553] [cursor=pointer]:
                      - generic [ref=e2554]: 選択
              - generic [ref=e2557]:
                - generic [ref=e2559]:
                  - heading "商品" [level=2] [ref=e2560]
                  - generic [ref=e2562]:
                    - textbox "商品を検索する" [ref=e2565]
                    - button "参照" [ref=e2567] [cursor=pointer]:
                      - generic [ref=e2568]: 参照
                - generic [ref=e2569]:
                  - separator [ref=e2570]
                  - table [ref=e2574]:
                    - rowgroup [ref=e2575]:
                    ...
                    - rowgroup [ref=e2586]:
                      - row "product thumbnail バギーカーブジーンズ BLUE / 36 487973 487973-64-36 増減数 1 商品を削除" [ref=e2587]:
                        - cell "product thumbnail バギーカーブジーンズ BLUE / 36" [ref=e2588]
                        - cell "487973" [ref=e2597]
                        - cell "487973-64-36" [ref=e2599]
                        - cell "増減数 1" [ref=e2601]
                        - cell "商品を削除" [ref=e2611]
            - generic [ref=e2623]:
  ...
  - generic:
    - generic:
      - generic:
        - generic:
          - generic:
            - dialog "在庫調整を実行する" [active]:
              - generic [ref=e2652]:
                - generic [ref=e2654]:
                  - heading "在庫調整を実行する" [level=2] [ref=e2656]
                  - button "閉じる" [ref=e2657] [cursor=pointer]:
                    - img [ref=e2660]
                - paragraph [ref=e2665]: 在庫調整を実行することで明細に登録されている差分値が在庫数に反映されます。この処理は巻き戻すことができません。
                - generic [ref=e2669]:
                  - button "キャンセル" [ref=e2670] [cursor=pointer]:
                    - generic [ref=e2671]: キャンセル
                  - button "実行する" [ref=e2672] [cursor=pointer]:
                    - generic [ref=e2673]: 実行する
  - alert [ref=e15]