- generic [ref=e1] [box=0,0,1600,1000]:
  - generic [ref=e16] [box=0,0,1600,1000]:
    ...
    - main [ref=e254] [box=0,0,1600,1000]:
      - generic [ref=e257] [box=240,56,1359,335]:
        - generic [ref=e258] [box=264,56,1311,76]:
          - status [box=264,80,1311,0]:
            - paragraph [ref=e259] [box=264,56,1,1]: TEST_FAQ_COVERAGE_20260615_THRESHOLD_DETAIL_OK。このページの準備が整いました
          - generic [ref=e261] [box=264,80,1311,28]:
            - link [ref=e264] [cursor=pointer] [box=264,80,28,28]:
              - /url: /admin/inventory_threshold_rules
              - img [ref=e267] [box=268,84,20,20]
            - generic [ref=e270] [box=296,80,711,28]:
              - heading "TEST_FAQ_COVERAGE_20260615_THRESHOLD_DETAIL_OK" [level=1] [ref=e271] [box=296,82,568,24]
              - generic [ref=e273] [box=872,84,136,20]:
                - generic [ref=e274] [box=880,56,1,1]: 情報
                - generic [ref=e275] [box=880,86,120,16]: デフォルト閾値が有効
            - generic [ref=e276] [box=1023,80,552,28]:
              - generic [ref=e279] [box=1023,80,436,28]:
                - link "自動追加ルール" [ref=e281] [cursor=pointer] [box=1224,80,108,28]:
                  - /url: /admin/inventory_threshold_rules/98f702bd-ea04-5fe2-92a6-bd0136345287_InventoryThresholdRule/automatic_add_rules
                  - generic [ref=e282] [box=1236,86,84,16]: 自動追加ルール
                - button "ルールを編集する" [ref=e284] [cursor=pointer] [box=1339,80,120,28]:
                  - generic [ref=e285] [box=1351,86,96,16]: ルールを編集する
              - link "閾値を追加する" [ref=e288] [cursor=pointer] [box=1467,80,108,28]:
                - /url: /admin/inventory_threshold_rules/98f702bd-ea04-5fe2-92a6-bd0136345287_InventoryThresholdRule/create
                - generic [ref=e289] [box=1479,86,84,16]: 閾値を追加する
        - generic [ref=e294] [box=264,132,1311,259]:
          - generic [ref=e304] [box=272,140,1283,28]:
            - generic [ref=e307] [box=272,132,131,20]: SKUコードで検索する
            - generic [ref=e310] [box=272,140,1283,28]:
              - img [ref=e314] [box=280,144,20,20]
              - textbox "SKUコードで検索する" [active] [ref=e316] [box=304,140,1251,28]
          - generic [ref=e318] [box=264,177,1311,214]:
            - generic [ref=e320] [box=280,177,1279,157]:
              - img "空の検索結果" [ref=e322] [box=890,193,60,60]
              - paragraph [ref=e324] [box=773,274,293,24]: アイテムが見つかりませんでした
              - paragraph [ref=e327] [box=784,314,272,20]: 絞り込みや検索ワードを変更してみてください
            - navigation "ページネーション" [ref=e329] [box=264,350,1311,41]:
              - generic [ref=e332] [box=893,357,57,28]:
                - generic [ref=e333] [box=893,357,28,28]:
                  - button "前へ" [disabled] [box=893,357,28,28]:
                    - generic [box=897,361,20,20]
                - generic [ref=e334] [box=922,357,28,28]:
