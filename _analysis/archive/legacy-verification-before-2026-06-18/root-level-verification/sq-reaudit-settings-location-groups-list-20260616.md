  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: ロケーショングループ。このページの準備が整いました
          - generic [ref=e238]:
            - link [ref=e241] [cursor=pointer]:
              - /url: /admin/settings
              - img [ref=e244]
            - heading "ロケーショングループ" [level=1] [ref=e248]
            - link "グループを作成" [ref=e252] [cursor=pointer]:
              - /url: /admin/settings/location_groups/create
              - generic [ref=e253]: グループを作成
        - generic [ref=e256]:
          - generic [ref=e258]:
            - tablist [ref=e263]:
            ...
            - generic [ref=e269]:
              - table [ref=e271]:
                - rowgroup [ref=e272]:
                  - row "グループ名 デフォルト ロケーション" [ref=e273]:
                    - columnheader "グループ名" [ref=e274]
                    - columnheader "デフォルト" [ref=e276]
                    - columnheader "ロケーション" [ref=e278]
                - rowgroup [ref=e280]:
                  - row "TEST_FAQ_COVERAGE_20260615_403698_ロケーショングループ TEST_FAQ_COVERAGE_20260615_403698_ロケーション 1個のロケーション" [ref=e281] [cursor=pointer]:
                    - cell "TEST_FAQ_COVERAGE_20260615_403698_ロケーショングループ" [ref=e282]
                    - cell "TEST_FAQ_COVERAGE_20260615_403698_ロケーション" [ref=e284]
                    - cell "1個のロケーション" [ref=e286]
                  - row "TEST_FAQ_ロケーショングループ 物流倉庫 4個のロケーション" [ref=e288] [cursor=pointer]:
                    - cell "TEST_FAQ_ロケーショングループ" [ref=e289]
                    - cell "物流倉庫" [ref=e291]
                    - cell "4個のロケーション" [ref=e293]
              - navigation "ページネーション" [ref=e298]:
                - generic [ref=e301]:
                  - generic [ref=e302]:
                    - button "前へ" [disabled]
                  - generic [ref=e303]:
                    - button "次へ" [disabled]
          - paragraph [ref=e305]:
            - button "ロケーショングループ" [ref=e306] [cursor=pointer]:
              - generic [ref=e307]: ロケーショングループ
            - text: についてもっと詳しくみる
