- generic [ref=e1] [box=0,0,1600,1000]:
  - generic [ref=e16] [box=0,0,1600,1000]:
    ...
    - main [ref=e254] [box=0,0,1600,1000]:
      - generic [ref=e257] [box=589,56,662,400]:
        - generic [ref=e258] [box=613,56,614,76]:
          - status [box=613,80,614,0]:
            - paragraph [ref=e259] [box=613,56,1,1]: 販売閾値ルールを作成する。このページの準備が整いました
          - generic [ref=e261] [box=613,80,614,28]:
            - link [ref=e264] [cursor=pointer] [box=613,80,28,28]:
              - /url: /admin/inventory_threshold_rules
              - img [ref=e267] [box=617,84,20,20]
            - heading "販売閾値ルールを作成する" [level=1] [ref=e271] [box=645,82,237,24]
        - generic [ref=e273] [box=597,116,630,340]:
          - generic [ref=e277] [box=629,148,582,216]:
            - generic [ref=e279] [box=629,148,582,56]:
              - generic [ref=e282] [box=629,148,62,20]: ルール名*
              - textbox "ルール名*" [ref=e286] [box=629,172,582,32]: TEST_FAQ_COVERAGE_20260615_THRESHOLD_DETAIL_OK
            - generic [ref=e288] [box=629,220,582,68]:
              - generic [ref=e289] [cursor=pointer] [box=629,220,194,28]:
                - generic [ref=e291] [box=630,226,16,16]:
                  - checkbox "デフォルトの閾値を設定する" [checked] [active] [ref=e292] [box=630,226,16,16]
                  - generic [box=632,228,12,12]:
                    - img [box=632,228,12,12]
                - generic [ref=e294] [box=655,224,168,20]: デフォルトの閾値を設定する
              - generic [ref=e296] [box=655,248,556,40]: この設定を有効にすることで、閾値ルールに含まれていないすべての商品バリエーションにデフォルト閾値を適用することができます。
            - generic [ref=e304] [box=629,308,582,56]:
              - generic [ref=e307] [box=629,308,114,20]: デフォルトの閾値*
              - textbox "デフォルトの閾値*" [ref=e311] [box=629,332,582,32]:
                - /placeholder: 入力してください
                - text: "0"
          - button "保存する" [ref=e301] [cursor=pointer] [box=1155,412,72,28]:
            - generic [ref=e302] [box=1167,418,48,16]: 保存する
