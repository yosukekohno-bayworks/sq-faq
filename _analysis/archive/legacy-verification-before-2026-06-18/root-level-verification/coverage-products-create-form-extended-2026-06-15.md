- generic [active] [ref=e1] [box=0,0,1600,1000]:
  - generic [ref=e16] [box=0,0,1600,1594]:
    ...
    - main [ref=e244] [box=0,0,1600,1594]:
      - generic [ref=e247] [box=421,56,998,1506]:
        - generic [ref=e248] [box=445,56,950,76]:
          - status [box=445,80,950,0]:
            - paragraph [ref=e249] [box=445,56,1,1]: 商品を作成する。このページの準備が整いました
          - generic [ref=e251] [box=445,80,950,28]:
            - link [ref=e254] [cursor=pointer] [box=445,80,28,28]:
              - /url: /admin/products
              - img [ref=e257] [box=449,84,20,20]
            - heading "商品を作成する" [level=1] [ref=e261] [box=477,82,139,24]
        - generic [ref=e263] [box=429,116,966,1446]:
          - generic [ref=e265] [box=445,132,623,1354]:
            - generic [ref=e268] [box=461,148,591,467]:
              - generic [ref=e269] [box=461,148,591,330]:
                - generic [ref=e271] [box=461,148,591,80]:
                  - generic [ref=e274] [box=461,148,76,20]: 商品コード*
                  - textbox "商品コード*" [ref=e278] [box=461,172,591,32]:
                    - /placeholder: 7835152003XL180
                  - generic [ref=e279] [box=461,208,591,20]: 半角英数字（A〜Z、a〜z、0〜9）、ハイフン（-）、アンダースコア（_）のみご入力ください。
                - generic [ref=e281] [box=461,244,591,56]:
                  - generic [ref=e284] [box=461,244,50,20]: 商品名*
                  - textbox "商品名*" [ref=e288] [box=461,268,591,32]:
                    - /placeholder: 半袖Tシャツ
                - generic [ref=e290] [box=461,316,591,162]:
                  - generic [ref=e293] [box=461,316,39,20]: 説明文
                  - generic [ref=e296] [box=461,340,591,138]:
                    - textbox "説明文" [ref=e297] [box=461,340,591,110]
                    - generic "5000中0の文字を使用" [box=465,450,575,28]: 0/5000
              - generic [ref=e298] [box=461,490,591,125]:
                - heading "メディア" [level=2] [ref=e301] [box=461,498,46,16]
                - generic [ref=e304] [box=461,522,93,93]:
                  - generic [ref=e307] [box=461,132,116,20]: 画像をアップロード
                  - generic [ref=e308] [box=461,522,93,93]:
                    - button "画像をアップロード" [ref=e310] [box=507,522,253,27]
                    - button "追加" [ref=e313] [cursor=pointer] [box=483,555,48,28]
            - generic [ref=e317] [box=461,663,591,271]:
              - heading "バリエーション" [level=2] [ref=e318] [box=461,663,591,20]
              - generic [ref=e321] [box=461,695,591,239]:
                - generic [ref=e322] [box=462,696,589,189]:
                  - generic [ref=e325] [box=474,708,565,164]:
                    - group [ref=e326] [box=474,708,565,56]
                    - group [ref=e354] [box=474,776,565,56]
                    - generic [ref=e374] [box=474,844,565,28]
                  - separator [ref=e377] [box=462,884,589,1]
                - button "別のオプションを追加する" [ref=e379] [cursor=pointer] [box=470,893,196,32]:
                  - img [ref=e382] [box=476,899,20,20]
                  - generic [ref=e385] [box=498,899,156,20]: 別のオプションを追加する
            - generic [ref=e388] [box=461,982,591,266]:
              - heading "検索エンジンリスティング" [level=2] [ref=e389] [box=461,982,591,20]
              - generic [ref=e390] [box=461,1014,591,234]:
                - generic [ref=e392] [box=461,1014,591,56]:
                  - generic [ref=e395] [box=461,1014,90,20]: ページタイトル
                  - textbox "ページタイトル" [ref=e399] [box=461,1038,591,32]:
                    - /placeholder: 半袖Tシャツ
                - generic [ref=e401] [box=461,1086,591,162]:
                  - generic [ref=e404] [box=461,1086,141,20]: メタディスクリプション
                  - generic [ref=e407] [box=461,1110,591,138]:
                    - textbox "メタディスクリプション" [ref=e408] [box=461,1110,591,110]
                    - generic "5000中0の文字を使用" [box=465,1220,575,28]: 0/5000
            - generic [ref=e411] [box=445,1280,623,206]:
              - heading "メタフィールド" [level=2] [ref=e413] [box=461,1296,591,20]
              - generic [ref=e414] [box=445,1332,623,77]:
                - separator [ref=e415] [box=445,1332,623,1]
                - generic [ref=e418] [box=461,1349,591,44]:
                  - generic [ref=e419] [box=461,1349,209,44]:
                    - generic [ref=e420] [box=461,1349,209,20]
                    - paragraph [ref=e428] [box=461,1373,209,20]: 未設定
                  - button [ref=e430] [cursor=pointer] [box=1027,1345,28,28]:
                    - img [ref=e433] [box=1031,1349,20,20]
              - generic [ref=e435] [box=445,1409,623,77]:
                - separator [ref=e436] [box=445,1409,623,1]
                - generic [ref=e439] [box=461,1426,591,44]:
                  - generic [ref=e440] [box=461,1426,288,44]:
                    - generic [ref=e441] [box=461,1426,288,20]
                    - paragraph [ref=e449] [box=461,1450,288,20]: 未設定
                  - button [ref=e451] [cursor=pointer] [box=1027,1422,28,28]:
                    - img [ref=e454] [box=1031,1426,20,20]
          - generic [ref=e457] [box=1083,132,311,476]:
            - generic [ref=e460] [box=1099,148,279,64]:
              - heading "ステータス" [level=2] [ref=e461] [box=1099,148,279,20]
              - generic [ref=e463] [box=1099,180,279,32]:
                - combobox [ref=e464] [box=1099,180,279,32]:
                  - option "下書き" [selected] [box=0,0,0,0]
                  - option "公開" [box=0,0,0,0]
                  - option "非公開" [box=0,0,0,0]
                - generic [ref=e465] [box=1099,180,279,32]:
                  - generic [ref=e466] [box=1111,186,239,20]: 下書き
                  - img [ref=e469] [box=1351,186,20,20]
            - generic [ref=e475] [box=1099,260,279,232]:
              - heading "商品分類" [level=2] [ref=e476] [box=1099,260,279,20]
              - generic [ref=e477] [box=1099,292,279,200]:
                - generic [ref=e479] [box=1099,292,279,56]:
                  - generic [ref=e482] [box=1099,292,65,20]: 商品タイプ
                  - textbox "商品タイプ" [ref=e486] [box=1099,316,279,32]:
                    - /placeholder: Tシャツ
                - generic [ref=e488] [box=1099,364,279,56]:
                  - generic [ref=e491] [box=1099,364,39,20]: 製造元
                  - textbox "製造元" [ref=e495] [box=1099,388,279,32]:
                    - /placeholder: ユニクロ
                - generic [ref=e497] [box=1099,436,279,56]:
                  - generic [ref=e500] [box=1099,436,52,20]: ブランド
                  - generic [ref=e501] [box=1099,460,279,32]:
                    - textbox "ブランド" [ref=e504] [box=1099,460,225,32]:
                      - /placeholder: 選択してください
                    - button "選択" [ref=e506] [cursor=pointer] [box=1329,460,50,32]
            - generic [ref=e510] [box=1099,540,279,52]:
              - generic [ref=e511] [box=1099,540,279,20]:
                - heading "タグ" [level=2] [ref=e512] [box=1099,540,26,20]
                - button [ref=e513] [cursor=pointer] [box=1355,536,28,28]:
                  - img [ref=e516] [box=1359,540,20,20]
              - paragraph [ref=e521] [box=1099,572,155,20]: タグは付与されていません
          - button "保存する" [ref=e526] [cursor=pointer] [box=1323,1518,72,28]:
            - generic [ref=e527] [box=1335,1524,48,16]: 保存する
  - region "Notifications alt+T" [box=0,1594,1600,0]
  - alert [ref=e15] [box=-1,1593,1,1]