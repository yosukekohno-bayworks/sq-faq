  ...
  - generic [ref=e16]:
    ...
    - main [ref=e252]:
      - generic [ref=e2957]:
        - generic [ref=e2958]:
          - status:
            - paragraph [ref=e2959]: "#IR-1002。このページの準備が整いました"
          - generic [ref=e2961]:
            - link [ref=e2964] [cursor=pointer]:
              - /url: /admin/inventory_reservation_orders
              - img [ref=e2967]
            - heading "#IR-1002" [level=1] [ref=e2971]
            - button "処理済みとしてマークする" [ref=e2977] [cursor=pointer]:
              - generic [ref=e2978]: 処理済みとしてマークする
        - generic [ref=e2980]:
          - generic [ref=e2982]:
            - generic [ref=e2985]:
              - heading "ロケーション" [level=2] [ref=e2986]
              - paragraph [ref=e2987]: 物流倉庫
            - generic [ref=e2990]:
              - heading "商品" [level=2] [ref=e2992]
              - generic [ref=e2993]:
                - separator [ref=e2994]
                - table [ref=e2998]:
                  - rowgroup [ref=e2999]:
                    - row "商品 商品コード SKU 数量" [ref=e3000]
                  - rowgroup [ref=e3009]:
                    - row "product thumbnail オーバーサイズスウェットシャツ BEIGE / XL 486125 486125-31-XL 1" [ref=e3010] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BLACK / XL 486125 486125-09-XL 3" [ref=e3026] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BLACK / XL 486125 486125-09-XL 1" [ref=e3042] [cursor=pointer]
          - generic [ref=e3063]:
            - heading "詳細" [level=2] [ref=e3064]
            - generic [ref=e3065]:
              - term [ref=e3066]: メモ
              - definition [ref=e3067]: Codex verification 2026-06-15
            - generic [ref=e3068]:
              - term [ref=e3069]: 作成日
              - definition [ref=e3070]: 2026年06月15日 15:16
        ...
        - generic:
          - generic:
            - dialog "処理済みとしてマークする" [active]:
              - generic [ref=e3071]:
                - generic [ref=e3073]:
                  - heading "処理済みとしてマークする" [level=2] [ref=e3075]
                  - button "閉じる" [ref=e3076] [cursor=pointer]:
                    - img [ref=e3079]
                - paragraph [ref=e3084]: 取置伝票を処理済みにすることで、取置中の在庫が解放されます。
                - generic [ref=e3088]:
                  - button "キャンセル" [ref=e3089] [cursor=pointer]:
                    - generic [ref=e3090]: キャンセル
                  - button "実行する" [ref=e3091] [cursor=pointer]:
                    - generic [ref=e3092]: 実行する
  - alert [ref=e15]