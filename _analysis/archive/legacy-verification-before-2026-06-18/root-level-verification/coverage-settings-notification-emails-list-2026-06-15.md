- generic [active] [ref=e1] [box=0,0,1600,1000]:
  - generic [ref=e16] [box=0,0,1600,1000]:
    ...
    - main [ref=e231] [box=0,0,1600,1000]:
      - generic [ref=e234] [box=421,56,998,335]:
        - generic [ref=e235] [box=445,56,950,76]:
          - status [box=445,80,950,0]:
            - paragraph [ref=e236] [box=445,56,1,1]: 通知用メールアドレス。このページの準備が整いました
          - generic [ref=e238] [box=445,80,950,28]:
            - link [ref=e241] [cursor=pointer] [box=445,80,28,28]:
              - /url: /admin/settings
              - img [ref=e244] [box=449,84,20,20]
            - heading "通知用メールアドレス" [level=1] [ref=e248] [box=477,82,195,24]
            - link "メールアドレスを追加" [ref=e252] [cursor=pointer] [box=1252,80,142,28]:
              - /url: /admin/settings/organization_notification_emails/create
              - generic [ref=e253] [box=1264,86,118,16]: メールアドレスを追加
        - generic [ref=e258] [box=445,132,950,259]:
          - tablist [ref=e263] [box=453,140,934,28]:
            - tab "すべて" [selected] [ref=e264] [cursor=pointer] [box=457,141,59,28]:
              - generic [ref=e266] [box=469,147,35,16]: すべて
          - separator [ref=e267] [box=445,176,950,1]
          - generic [ref=e269] [box=445,177,950,214]:
            - generic [ref=e271] [box=461,177,918,157]:
              - img "空の検索結果" [ref=e273] [box=890,193,60,60]
              - paragraph [ref=e275] [box=773,274,293,24]: アイテムが見つかりませんでした
              - paragraph [ref=e278] [box=784,314,272,20]: 絞り込みや検索ワードを変更してみてください
            - navigation "ページネーション" [ref=e280] [box=445,350,950,41]:
              - generic [ref=e283] [box=893,357,57,28]:
                - generic [ref=e284] [box=893,357,28,28]:
                  - button "前へ" [disabled] [box=893,357,28,28]:
                    - generic [box=897,361,20,20]
                - generic [ref=e285] [box=922,357,28,28]:
