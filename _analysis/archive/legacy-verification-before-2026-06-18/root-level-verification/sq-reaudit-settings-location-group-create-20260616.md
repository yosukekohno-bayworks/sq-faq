  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: グループを作成。このページの準備が整いました
          - generic [ref=e238]:
            - link [ref=e241] [cursor=pointer]:
              - /url: /admin/settings/location_groups
              - img [ref=e244]
            - heading "グループを作成" [level=1] [ref=e248]
        - generic [ref=e250]:
          - generic [ref=e252]:
            - generic [ref=e255]:
              - generic [ref=e258]: 名前*
            ...
            - generic [ref=e268]:
              ...
              - generic [ref=e272]:
                - textbox "ロケーション" [ref=e275]:
                  - /placeholder: ロケーションを選択してください
                - button "選択" [ref=e277] [cursor=pointer]:
                  - generic [ref=e278]: 選択
              - generic [ref=e279]: このグループに属するロケーションを選択してください
          - button "保存する" [ref=e284] [cursor=pointer]:
            - generic [ref=e285]: 保存する
