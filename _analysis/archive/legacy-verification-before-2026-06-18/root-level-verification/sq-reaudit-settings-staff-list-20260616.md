  ...
  - generic [ref=e16]:
    ...
    - main [ref=e231]:
      - generic [ref=e234]:
        - generic [ref=e235]:
          - status:
            - paragraph [ref=e236]: 販売員。このページの準備が整いました
          - generic [ref=e238]:
            - link [ref=e241] [cursor=pointer]:
              - /url: /admin/settings
              - img [ref=e244]
            - heading "販売員" [level=1] [ref=e248]
            - link "販売員を追加する" [ref=e252] [cursor=pointer]:
              - /url: /admin/settings/retail_staff_members/create
              - generic [ref=e253]: 販売員を追加する
        - generic [ref=e258]:
          - generic [ref=e268]:
            - generic [ref=e271]: 販売員コードで検索する
            - generic [ref=e274]:
              - img [ref=e278]
              - textbox "販売員コードで検索する" [active] [ref=e280]
          - generic [ref=e282]:
            - table [ref=e284]:
              - rowgroup [ref=e285]:
                - row "すべてのアイテムを選択する 名前 販売員コード 外部ID" [ref=e286]:
                  - columnheader "すべてのアイテムを選択する" [ref=e287]:
                    - generic [ref=e289] [cursor=pointer]
                  - columnheader "名前" [ref=e295]:
                    - generic [ref=e296]: 名前
                  - columnheader "販売員コード" [ref=e297]:
                    - generic [ref=e298]: 販売員コード
                  - columnheader "外部ID" [ref=e299]:
                    - generic [ref=e300]: 外部ID
              - rowgroup [ref=e301]:
                - row "アイテムを選択する 銀座ユニクロ 123" [ref=e302] [cursor=pointer]:
                  - cell "アイテムを選択する" [ref=e303]:
                    - generic [ref=e305]
                  - cell "銀座ユニクロ" [ref=e311]:
                    - paragraph [ref=e312]: 銀座ユニクロ
                  - cell "123" [ref=e313]:
                    - paragraph [ref=e314]: "123"
                  - cell [ref=e315]:
                    - paragraph
                - row "アイテムを選択する TEST_APPCHECK販売員 APPCHK-20260616212742" [ref=e316] [cursor=pointer]:
                  - cell "アイテムを選択する" [ref=e317]:
                    - generic [ref=e319]
                  - cell "TEST_APPCHECK販売員" [ref=e325]:
                    - paragraph [ref=e326]: TEST_APPCHECK販売員
                  - cell "APPCHK-20260616212742" [ref=e327]:
                    - paragraph [ref=e328]: APPCHK-20260616212742
                  - cell [ref=e329]:
                    - paragraph
            - navigation "ページネーション" [ref=e333]:
              - generic [ref=e336]:
                - generic [ref=e337]:
                  - button "前へ" [disabled]:
                    - generic
