- generic [ref=e1]:
  - generic [ref=e16]:
    ...
    - generic [ref=e589]:
      - generic [ref=e590]:
        - img [ref=e592]
        - heading "保存されていないテナント" [level=2] [ref=e596]
      - generic [ref=e598]:
        - button "取り消す" [ref=e600] [cursor=pointer]:
          - generic [ref=e601]: 取り消す
        - button "保存する" [ref=e603] [cursor=pointer]:
          - generic [ref=e604]: 保存する
    - main [ref=e231]:
      - generic [ref=e552]:
        - generic [ref=e553]:
          - status:
            - paragraph [ref=e554]: テナントを作成。このページの準備が整いました
          - generic [ref=e556]:
            - link [ref=e559] [cursor=pointer]:
              - /url: /admin/settings/tenants
              - img [ref=e562]
            - heading "テナントを作成" [level=1] [ref=e566]
        - generic [ref=e568]:
          - generic [ref=e573]:
            - generic [ref=e576]: テナント名*
            - textbox "テナント名*" [active] [ref=e580]:
              - /placeholder: ブランド
              - text: TEST_FAQ_COVERAGE_20260615_テナント
            - generic [ref=e581]: テナント名は様々なデータの紐付けに使われます。ブランド名など事業部を表現するわかりやすい名前を設定してください。
          - button "保存する" [ref=e605] [cursor=pointer]:
            - generic [ref=e606]: 保存する
