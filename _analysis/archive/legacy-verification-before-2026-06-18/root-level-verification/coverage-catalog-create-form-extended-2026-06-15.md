- generic [active] [ref=e1] [box=0,0,1600,1000]:
  - generic [ref=e16] [box=0,0,1600,1000]:
    ...
    - main [ref=e244] [box=0,0,1600,1000]:
      - generic [ref=e247] [box=589,56,662,240]:
        - generic [ref=e248] [box=613,56,614,76]:
          - status [box=613,80,614,0]:
            - paragraph [ref=e249] [box=613,56,1,1]: カタログを作成する。このページの準備が整いました
          - generic [ref=e251] [box=613,80,614,28]:
            - link [ref=e254] [cursor=pointer] [box=613,80,28,28]:
              - /url: /admin/catalogs
              - img [ref=e257] [box=617,84,20,20]
            - heading "カタログを作成する" [level=1] [ref=e261] [box=645,82,178,24]
        - generic [ref=e263] [box=597,116,630,180]:
          - generic [ref=e267] [box=629,148,582,56]:
            - generic [ref=e270] [box=629,148,62,20]: タイトル*
            - textbox "タイトル*" [ref=e274] [box=629,172,582,32]:
              - /placeholder: 渋谷店
          - button "保存する" [ref=e279] [cursor=pointer] [box=1155,252,72,28]:
            - generic [ref=e280] [box=1167,258,48,16]: 保存する
