- generic [active] [ref=e1] [box=0,0,1600,1000]:
  - generic [ref=e16] [box=0,0,1600,1000]:
    ...
    - main [ref=e231] [box=0,0,1600,1000]:
      - generic [ref=e395] [box=589,56,662,456]:
        - generic [ref=e396] [box=613,56,614,76]:
          - status [box=613,80,614,0]:
            - paragraph [ref=e397] [box=613,56,1,1]: 翻訳ルールを作成する。このページの準備が整いました
          - generic [ref=e399] [box=613,80,614,28]:
            - link [ref=e402] [cursor=pointer] [box=613,80,28,28]:
              - /url: /admin/settings/translation/translation_rules
              - img [ref=e405] [box=617,84,20,20]
            - heading "翻訳ルールを作成する" [level=1] [ref=e409] [box=645,82,197,24]
        - generic [ref=e410] [box=613,116,614,396]:
          - generic [ref=e413] [box=613,132,614,320]:
            - generic [ref=e416] [box=629,148,582,176]:
              - generic [ref=e418] [box=629,148,582,80]:
                - generic [ref=e421] [box=629,148,37,20]: 名前*
                - textbox "名前*" [invalid] [ref=e425] [box=629,172,582,32]
                - generic [ref=e457] [box=629,208,582,20]:
                  - img [ref=e460] [box=627,208,20,20]
                  - generic [ref=e464] [box=653,208,142,20]: 名前を入力してください
              - generic [ref=e427] [box=629,244,582,80]:
                - generic [ref=e430] [box=629,244,37,20]: 言語*
                - generic [ref=e431] [box=629,268,582,32]:
                  - combobox "言語*" [invalid] [ref=e432] [box=629,268,582,32]:
                    - option "選択してください" [disabled] [selected] [box=0,0,0,0]
                    - option "日本語" [box=0,0,0,0]
                    - option "英語" [box=0,0,0,0]
                  ...
                  - generic [ref=e433] [box=629,268,582,32]:
                    - generic [ref=e434] [box=641,274,542,20]: 選択してください
                    - img [ref=e437] [box=1183,274,20,20]
                - generic [ref=e466] [box=629,304,582,20]:
                  - img [ref=e469] [box=627,304,20,20]
                  - generic [ref=e473] [box=653,304,142,20]: 言語を選択してください
            - generic [ref=e443] [box=629,372,582,64]:
              - heading "各種設定" [level=2] [ref=e444] [box=629,372,582,20]
              - generic [ref=e445] [cursor=pointer] [box=629,408,582,28]:
                - generic [ref=e447] [box=630,414,16,16]:
                  - checkbox "翻訳データを自動で作成する" [ref=e448] [box=630,414,16,16]
                  - generic [box=632,416,12,12]:
                    - img [box=632,416,12,12]
                - generic [ref=e450] [box=655,412,169,20]: 翻訳データを自動で作成する
          - button "保存する" [ref=e454] [cursor=pointer] [box=1155,468,72,28]:
            - generic [ref=e455] [box=1167,474,48,16]: 保存する
