  ...
  - generic [ref=f8e11]:
    ...
    - main [ref=f8e226]:
      - generic [ref=f8e316]:
        - generic [ref=f8e317]:
          - status:
            - paragraph [ref=f8e318]: CSVインポート操作の詳細。このページの準備が整いました
          - generic [ref=f8e320]:
            - link [ref=f8e323] [cursor=pointer]:
              - /url: /admin/csv_import/csv_import_operation_fulfillment_by_yamato_b2_clouds
              - img [ref=f8e326]
            - heading "CSVインポート操作の詳細" [level=1] [ref=f8e330]
            - generic [ref=f8e333]:
        ...
        - generic [ref=f8e337]:
          - status [ref=f8e338]:
            - generic [ref=f8e342]:
              - img [ref=f8e347]
              - paragraph [ref=f8e355]: CSVのバリデーションを実行しています。バリデーションが完了すると、取り込み処理を実行できるようになります。
          - generic [ref=f8e358]:
            - generic [ref=f8e359]:
              - heading "作成日" [level=3] [ref=f8e360]
              - paragraph [ref=f8e361]: 2026年07月02日
            - generic [ref=f8e362]:
              - heading "実行ステータス" [level=3] [ref=f8e363]
              - generic [ref=f8e366]: 未実行
            - generic [ref=f8e367]:
              - heading "検証成功" [level=3] [ref=f8e368]
              - link "0件の出荷結果" [ref=f8e369] [cursor=pointer]:
                ...
                - paragraph [ref=f8e370]: 0件の出荷結果
            - generic [ref=f8e371]:
              - heading "検証失敗" [level=3] [ref=f8e372]
              - link "0件の出荷結果" [ref=f8e373] [cursor=pointer]:
                ...
                - paragraph [ref=f8e374]: 0件の出荷結果
  - region "Notifications alt+T":
    - list:
      - listitem [ref=f8e306]:
        - button "Close toast" [ref=f8e307] [cursor=pointer]:
          - img [ref=f8e308]
        - img [ref=f8e312]
        - generic [ref=f8e315]: CSVインポートの検証を開始しました
  - alert [ref=f8e10]