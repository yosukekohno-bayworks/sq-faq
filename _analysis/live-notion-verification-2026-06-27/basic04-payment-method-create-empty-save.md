  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: 決済方法を作成する。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/settings/payment_methods
              - img [ref=e235]
            - heading "決済方法を作成する" [level=1] [ref=e239]
        - generic [ref=e241]:
          - generic [ref=e245]:
            - heading "詳細" [level=2] [ref=e246]
            - generic [ref=e247]:
              - generic [ref=e249]:
                - generic [ref=e252]: 名前*
                - textbox "名前*" [invalid] [ref=e256]:
                  - /placeholder: クレジットカード
                - generic [ref=e296]:
                  - img [ref=e299]
                  - generic [ref=e303]: 決済方法の名前を入力してください
              - generic [ref=e258]:
                - generic [ref=e261]: コード*
                - textbox "コード*" [invalid] [ref=e265]:
                  - /placeholder: credit_card
                - generic [ref=e305]:
                  - img [ref=e308]
                  - generic [ref=e312]: この決済方法のコードを入力してください
              - generic [ref=e267]:
                - generic [ref=e270]: ゲートウェイ*
                - textbox "ゲートウェイ*" [invalid] [ref=e274]:
                  - /placeholder: shopify_payments
                - generic [ref=e314]:
                  - img [ref=e317]
                  - generic [ref=e321]: ゲートウェイを入力してください
              - generic [ref=e276] [cursor=pointer]:
                - generic [ref=e278]:
                  - checkbox "支払い待ちでも注文を出荷する" [ref=e279]
                  - generic:
                    - img
                - generic [ref=e281]: 支払い待ちでも注文を出荷する
              - generic [ref=e283] [cursor=pointer]:
                - generic [ref=e285]:
                  - checkbox "代引き" [ref=e286]
                  - generic:
                    - img
                - generic [ref=e288]: 代引き
          - button "保存する" [ref=e293] [cursor=pointer]:
            - generic [ref=e294]: 保存する
