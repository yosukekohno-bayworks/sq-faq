        ...
        - generic:
          - generic:
            - dialog "在庫調整を実行する" [active]:
              - generic [ref=e3086]:
                - generic [ref=e3088]:
                  - heading "在庫調整を実行する" [level=2] [ref=e3090]
                  - button "閉じる" [ref=e3091] [cursor=pointer]:
                    - img [ref=e3094]
                - paragraph [ref=e3099]: 在庫調整を実行することで明細に登録されている差分値が在庫数に反映されます。この処理は巻き戻すことができません。
                - generic [ref=e3103]:
                  - button "キャンセル" [ref=e3104] [cursor=pointer]:
                    - generic [ref=e3105]: キャンセル
                  - button "実行する" [ref=e3106] [cursor=pointer]:
                    - generic [ref=e3107]: 実行する
  - alert [ref=e10]