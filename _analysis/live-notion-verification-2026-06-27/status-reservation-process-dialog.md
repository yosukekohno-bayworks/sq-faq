            ...
            - generic [ref=e3354]:
              ...
              - generic [ref=e3357]:
                ...
                - table [ref=e3362]:
                  ...
                  - rowgroup [ref=e3373]:
                    - row "product thumbnail オーバーサイズスウェットシャツ BEIGE / XL 486125 486125-31-XL 1" [ref=e3374] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BLACK / XL 486125 486125-09-XL 3" [ref=e3390] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BLACK / XL 486125 486125-09-XL 1" [ref=e3406] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BEIGE / XL 486125 486125-31-XL 1" [ref=e3422] [cursor=pointer]
                    - row "product thumbnail バギーカーブジーンズ BLUE / 36 487973 487973-64-36 1" [ref=e3438] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BEIGE / XL 486125 486125-31-XL 1" [ref=e3454] [cursor=pointer]
                    - row "product thumbnail バギーカーブジーンズ BLUE / 36 487973 487973-64-36 1" [ref=e3470] [cursor=pointer]
                    - row "product thumbnail エアリズムコットンT PINK / L 483457 483457-10-L 1" [ref=e3486] [cursor=pointer]
                    - row "product thumbnail オーバーサイズスウェットシャツ BEIGE / XL 486125 486125-31-XL 1" [ref=e3502] [cursor=pointer]
                    - row "product variant thumbnail TEST_E2E_20260622 GU検証Tシャツ 1905 NAVY / M TEST_E2E_20260622_GU_1905 TEST_E2E_20260622_GU_1905_NAVY_M 1" [ref=e3518] [cursor=pointer]
          - generic [ref=e3544]:
        ...
        - generic:
          - generic:
            - dialog "処理済みとしてマークする" [active]:
              - generic [ref=e3551]:
                - generic [ref=e3553]:
                  - heading "処理済みとしてマークする" [level=2] [ref=e3555]
                  - button "閉じる" [ref=e3556] [cursor=pointer]:
                    - img [ref=e3559]
                - paragraph [ref=e3564]: 取置伝票を処理済みにすることで、取置中の在庫が解放されます。
                - generic [ref=e3568]:
                  - button "キャンセル" [ref=e3569] [cursor=pointer]:
                    - generic [ref=e3570]: キャンセル
                  - button "実行する" [ref=e3571] [cursor=pointer]:
                    - generic [ref=e3572]: 実行する
  - alert [ref=e10]