  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e666]:
        - generic [ref=e667]:
          - status:
            - paragraph [ref=e668]: TEST_FAQ_DEEP3_202606080345_ディスカウント。このページの準備が整いました
          - generic [ref=e670]:
            - link [ref=e673] [cursor=pointer]:
              ...
              - img [ref=e676]
            - generic [ref=e679]:
              - heading "TEST_FAQ_DEEP3_202606080345_ディスカウント" [level=1] [ref=e680]
              - generic [ref=e682]:
                - generic [ref=e683]: 成功
                - generic [ref=e684]: 有効
        - generic [ref=e686]:
          - tablist [ref=e692]:
            - link "基本情報" [ref=e693] [cursor=pointer]:
              - /url: /admin/order_price_adjustment_rules/2c0e23bd-77df-5440-a291-2c8dfd057f45_OrderPriceAdjustmentRule
              - generic [ref=e695]: 基本情報
            - tab "利用履歴" [selected] [ref=e696] [cursor=pointer]:
              - generic [ref=e698]: 利用履歴
            - link "顧客管理" [ref=e699] [cursor=pointer]:
              - /url: /admin/order_price_adjustment_rules/2c0e23bd-77df-5440-a291-2c8dfd057f45_OrderPriceAdjustmentRule/customers
              - generic [ref=e701]: 顧客管理
            - link "店舗管理" [ref=e702] [cursor=pointer]:
              - /url: /admin/order_price_adjustment_rules/2c0e23bd-77df-5440-a291-2c8dfd057f45_OrderPriceAdjustmentRule/locations
              - generic [ref=e704]: 店舗管理
            - link "商品管理" [ref=e705] [cursor=pointer]:
              - /url: /admin/order_price_adjustment_rules/2c0e23bd-77df-5440-a291-2c8dfd057f45_OrderPriceAdjustmentRule/product_variants
              - generic [ref=e707]: 商品管理
          - generic [ref=e710]:
            - generic [ref=e712]:
              - heading "利用履歴" [level=2] [ref=e713]
              - link "CSVエクスポート" [ref=e714] [cursor=pointer]:
                - /url: /admin/csv_export/csv_export_operation_order_price_adjustment_usages
                - generic [ref=e715]: CSVエクスポート
            - separator [ref=e716]
            - generic [ref=e718]:
              - generic [ref=e720]:
                - img "空の検索結果" [ref=e722]
                - paragraph [ref=e724]: アイテムが見つかりませんでした
                - paragraph [ref=e727]: 絞り込みや検索ワードを変更してみてください
              - navigation "ページネーション" [ref=e729]:
                - generic [ref=e732]:
                  - generic [ref=e733]:
                    - button "前へ" [disabled]
                  - generic [ref=e734]:
