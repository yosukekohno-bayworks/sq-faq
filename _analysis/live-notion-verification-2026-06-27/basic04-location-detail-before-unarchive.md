            ...
            - generic [ref=e245]:
              - status [ref=e246]:
                - generic [ref=e248]:
                  - generic [ref=e251]:
                    - img [ref=e254]
                    - heading "このロケーションはアーカイブされています。" [level=2] [ref=e258]
                  - generic [ref=e260]:
                    - paragraph [ref=e263]: アーカイブされたロケーションは管理画面やストアフロントからも非表示となります。
                    - button "アーカイブを解除する" [ref=e266] [cursor=pointer]
              - generic [ref=e269]:
                - heading "基本情報" [level=2] [ref=e271]
                - separator [ref=e272]
                - generic [ref=e274]:
                  - generic [ref=e275]:
                    - paragraph [ref=e276]: ロケーションID
                    - generic [ref=e277]
                  - generic [ref=e284]:
                    - paragraph [ref=e285]: 外部ID
                    - paragraph [ref=e286]: 未設定
                  - generic [ref=e287]:
                    - generic [ref=e289]
                    - generic [ref=e298]
                    - generic [ref=e307]
              ...
              - generic [ref=e341]:
                - generic [ref=e343]:
                  - heading "所在地" [level=2] [ref=e344]
                  - button [ref=e346] [cursor=pointer]:
                    - img [ref=e349]
                - separator [ref=e353]
                - paragraph [ref=e355]: 未設定
              - generic [ref=e357]:
                - heading "連絡先" [level=2] [ref=e359]
                - separator [ref=e360]
                - generic [ref=e362]:
                  - generic [ref=e364]:
                    - generic [ref=e367]: マップ
                    - textbox "マップ" [ref=e371]:
                      - /placeholder: https://www.google.com/maps
                  - generic [ref=e373]:
                    - generic [ref=e376]: 電話番号
                    - textbox "電話番号" [ref=e380]:
                      - /placeholder: 03-1234-5678
                  - generic [ref=e382]:
                    - generic [ref=e385]: メールアドレス
                    - textbox "メールアドレス" [ref=e389]:
                      - /placeholder: example@example.com
              - generic [ref=e391]:
                - generic [ref=e392]:
                  - generic [ref=e393]:
                    - heading "所属ロケーショングループ" [level=2] [ref=e394]
                    - link [ref=e396] [cursor=pointer]:
                      - /url: https://docs.sqstack.com/docs/guide/data-management#ロケーショングループ
                  - paragraph [ref=e403]: 0個のグループに属しています
                - separator [ref=e404]
                - generic [ref=e408]:
                  - img "空の検索結果" [ref=e410]
                  - paragraph [ref=e412]: アイテムが見つかりませんでした
                  - paragraph [ref=e415]: 絞り込みや検索ワードを変更してみてください
            - generic [ref=e417]:
              - generic [ref=e420]:
                - heading "公開設定" [level=2] [ref=e421]
                - generic [ref=e422]:
                  - generic [ref=e425]: 公開設定
                  - generic [ref=e426]:
                    - combobox "公開設定" [disabled] [ref=e427]
                    - generic [ref=e428]
                  - generic [ref=e436]: 公開にすることでストアフロントからロケーション情報の参照が可能になります。
              - generic [ref=e439]:
                - heading "販売設定" [level=2] [ref=e440]
                - generic [ref=e441]:
                  - generic [ref=e442] [cursor=pointer]:
                    - generic [ref=e444]
                    - generic [ref=e447]: 店舗受取を有効にする
                  - generic [ref=e448] [cursor=pointer]:
                    - generic [ref=e450]
                    - generic [ref=e453]: 在庫依頼を受け付ける
                  - generic [ref=e454]:
                    - generic [ref=e457]: ポイント利用種別
                    - generic [ref=e458]
              - generic [ref=e470]:
                - heading "備考欄" [level=2] [ref=e471]
                - generic [ref=e472]:
                  - generic [ref=e475]: 備考欄
                  - generic [ref=e478]:
                    - textbox "備考欄" [ref=e479]:
              ...
              - generic [ref=e482]:
                - generic [ref=e483]:
                  ...
                  - button [ref=e485] [cursor=pointer]:
                    - img [ref=e488]
                - paragraph [ref=e490]: タグは付与されていません
          - generic [ref=e495]:
