      ...
      - generic [ref=e225]:
        - generic [ref=e226]:
          ...
          - generic [ref=e229]:
            ...
            - link "新規インポート" [ref=e243] [cursor=pointer]:
              - /url: /admin/csv_import/csv_import_operation_fulfillment_by_dhls/create
              - img [ref=e246]
              - generic [ref=e249]: 新規インポート
        - generic [ref=e256]:
          - generic [ref=e258]:
            - img "空の検索結果" [ref=e260]
            - paragraph [ref=e262]: アイテムが見つかりませんでした
            - paragraph [ref=e265]: 絞り込みや検索ワードを変更してみてください
          - navigation "ページネーション" [ref=e267]:
            - generic [ref=e270]:
              - generic [ref=e271]:
                - button "前へ" [disabled]
              - generic [ref=e272]:
