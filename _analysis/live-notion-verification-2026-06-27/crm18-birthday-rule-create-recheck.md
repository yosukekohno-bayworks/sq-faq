  ...
  - generic [ref=e11]:
    ...
    - main [ref=e245]:
      - generic [ref=e318]:
        - generic [ref=e319]:
          - status:
            - paragraph [ref=e320]: 誕生日ポイント付与ルールを作成する。このページの準備が整いました
          - generic [ref=e322]:
            - link [ref=e325] [cursor=pointer]:
              - /url: /admin/point_calculation_birthday_rules
              - img [ref=e328]
            - heading "誕生日ポイント付与ルールを作成する" [level=1] [ref=e332]
        - generic [ref=e334]:
          - generic [ref=e338]:
            - generic [ref=e340]:
              - generic [ref=e343]: タイトル
              - textbox "タイトル" [ref=e347]:
                - /placeholder: 誕生日ポイント付与ルール
            - generic [ref=e349]:
              - generic [ref=e352]: 表示タイトル
              - textbox "表示タイトル" [ref=e356]:
                - /placeholder: 誕生日ボーナス
              - generic [ref=e357]: 誕生日ポイントの履歴に表示されるタイトル
            - generic [ref=e359]:
              - generic [ref=e362]: ポイント
              - generic [ref=e365]:
                - spinbutton "ポイント ポイント" [ref=e366]: "0"
                - generic [ref=e367]: ポイント
            - generic [ref=e369]:
              - generic [ref=e372]: 有効期間
              - generic [ref=e375]:
                - spinbutton "有効期間 日" [ref=e376]: "1"
                - generic [ref=e377]: 日
              - generic [ref=e378]: ポイントを付与してから有効な日数
          - button "保存する" [ref=e383] [cursor=pointer]:
            - generic [ref=e384]: 保存する
