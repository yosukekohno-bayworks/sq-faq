  ...
  - generic [ref=e11]:
        ...
        - generic [ref=e38]:
          - list [ref=e39]:
            ...
            - listitem [ref=e67]:
              ...
              - list [ref=e78]:
                - listitem [ref=e79]:
                  - link "下書き" [ref=e82] [cursor=pointer]:
                    - /url: /admin/draft_orders
                    - generic [ref=e83]: 下書き
                - listitem [ref=e84]:
                  - link "返品" [ref=e87] [cursor=pointer]:
    ...
    - main [ref=e235]:
      - generic [ref=e238]:
        - generic [ref=e239]:
          - status:
            - paragraph [ref=e240]: 返品。このページの準備が整いました
          - heading "返品" [level=1] [ref=e245]
        - generic [ref=e250]:
          - generic [ref=e256]:
            - generic [ref=e260]:
              - generic:
                - generic:
                  - list
            - button "検索と絞り込みの結果" [ref=e264] [cursor=pointer]:
              - img [ref=e268]
          - generic [ref=e273]:
            - generic [ref=e275]:
              - img "空の検索結果" [ref=e277]
              - paragraph [ref=e279]: アイテムが見つかりませんでした
              - paragraph [ref=e282]: 絞り込みや検索ワードを変更してみてください
            - navigation "ページネーション" [ref=e284]:
              - generic [ref=e287]:
                - generic [ref=e288]:
                  - button "前へ" [disabled]:
                    - generic
