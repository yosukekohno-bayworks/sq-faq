          ...
          - generic [ref=e422]:
            ...
            - generic [ref=e430]:
              - generic [ref=e475]:
                ...
                - button "定義を削除" [ref=e485] [cursor=pointer]:
                  - generic [ref=e486]: 定義を削除
              - table [ref=e432]:
                - rowgroup [ref=e433]:
                  - row "すべてのアイテムを選択する 定義名 コンテンツタイプ 権限 使用箇所" [ref=e434]
                - rowgroup [ref=e451]:
                  - row "アイテムを選択する TEST_META_SHORT_20260627 abc.def 単一行のテキスト 編集可 1個の商品" [ref=e452] [cursor=pointer]
  ...
  - generic:
    - generic:
      - generic:
        - generic:
          - generic:
            - dialog "メタフィールドの定義を削除しますか？" [active]:
              - generic [ref=e487]:
                - generic [ref=e489]:
                  - heading "メタフィールドの定義を削除しますか？" [level=2] [ref=e491]
                  - button "閉じる" [ref=e492] [cursor=pointer]
                - paragraph [ref=e500]: 選択されているメタフィールドの定義を削除します。この処理は巻き戻すことができません。関連するメタフィールドの値は削除されません。
                - generic [ref=e504]:
                  - button "キャンセル" [ref=e505] [cursor=pointer]
                  - button "削除する" [ref=e507] [cursor=pointer]
  - alert [ref=e10]