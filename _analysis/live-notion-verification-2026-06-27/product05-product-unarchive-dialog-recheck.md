        ...
        - generic [ref=e269]:
          - generic [ref=e271]:
            ...
            - generic [ref=e366]:
              ...
              - generic [ref=e368]:
                - generic [ref=e370]:
                  - generic [ref=e373]: ページタイトル
                  - textbox "ページタイトル" [ref=e377]:
                    - /placeholder: 半袖Tシャツ
                - generic [ref=e379]:
                  - generic [ref=e382]: メタディスクリプション
                  - generic [ref=e385]:
                    - textbox "メタディスクリプション" [ref=e386]
                    - generic "5000中0の文字を使用": 0/5000
          - generic [ref=e388]:
            - generic [ref=e392]:
              - heading "ステータス" [level=2] [ref=e393]
              - generic [ref=e394]:
                - generic [ref=e397]: アーカイブ済み
                - paragraph [ref=e398]: 管理画面では、商品リスト以外は非表示です。
            - generic [ref=e401]:
              - heading "商品分類" [level=2] [ref=e402]
              - generic [ref=e403]:
                - generic [ref=e405]:
                  - generic [ref=e408]: 商品タイプ
                  - textbox "商品タイプ" [ref=e412]:
                    - /placeholder: Tシャツ
                - generic [ref=e414]:
                  - generic [ref=e417]: 製造元
                  - textbox "製造元" [ref=e421]:
                    - /placeholder: ユニクロ
                - generic [ref=e423]:
                  - generic [ref=e426]: ブランド
                  - generic [ref=e427]:
                    - textbox "ブランド" [ref=e430]:
                      - /placeholder: 選択してください
                    - button "選択" [ref=e432] [cursor=pointer]
            - generic [ref=e436]:
              - generic [ref=e437]:
  ...
  - generic:
    - generic:
      - generic:
        - generic:
          - generic:
            - dialog "商品のアーカイブを解除しますか？" [active]:
              - generic [ref=e476]:
                - generic [ref=e478]:
                  - heading "商品のアーカイブを解除しますか？" [level=2] [ref=e480]
                  - button "閉じる" [ref=e481] [cursor=pointer]:
                    - img [ref=e484]
                - paragraph [ref=e489]: この商品のアーカイブを解除すると、ステータスが下書きに変更され再び作業できるようになります。
                - generic [ref=e493]:
                  - button "キャンセル" [ref=e494] [cursor=pointer]:
                    - generic [ref=e495]: キャンセル
                  - button "商品のアーカイブを解除する" [ref=e496] [cursor=pointer]:
                    - generic [ref=e497]: 商品のアーカイブを解除する
  - alert [ref=e10]