  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: 権限グループ。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/settings/users
              - img [ref=e235]
            - heading "権限グループ" [level=1] [ref=e239]
            - link "作成する" [ref=e243] [cursor=pointer]:
              - /url: /admin/settings/permission_groups/create
              - img [ref=e246]
              - generic [ref=e248]: 作成する
        - generic [ref=e255]:
          - generic [ref=e258]:
            - generic [ref=e260] [cursor=pointer]:
              - generic:
                - generic:
                  - generic:
                    - generic
                  - generic: すべての3のアイテムを選択する
              - generic [ref=e262]: 1を選択済み
            - button "権限グループを削除" [ref=e268] [cursor=pointer]:
              - generic [ref=e269]: 権限グループを削除
          - table [ref=e271]:
            - rowgroup [ref=e272]:
              - row "すべてのアイテムを選択する 名前 権限数" [ref=e273]:
                - columnheader "すべてのアイテムを選択する" [ref=e274]:
                  - generic [ref=e276] [cursor=pointer]:
                    - generic [ref=e278]
                    - generic [ref=e281]: すべてのアイテムを選択する
                - columnheader "名前" [ref=e282]:
                  - generic [ref=e283]: 名前
                - columnheader "権限数" [ref=e284]:
                  - generic [ref=e285]: 権限数
            - rowgroup [ref=e286]:
              - row "アイテムを選択する TEST_NOTION_20260627_PERMISSION_0326 1" [ref=e287] [cursor=pointer]:
                - cell "アイテムを選択する" [ref=e288]:
                  - generic [ref=e290]:
                    - generic [ref=e292]
                    - generic [ref=e295]: アイテムを選択する
                - cell "TEST_NOTION_20260627_PERMISSION_0326" [ref=e296]:
                  - link "TEST_NOTION_20260627_PERMISSION_0326" [ref=e297]:
                    - /url: /admin/settings/permission_groups/6789c0ee-bf8f-5b37-88a0-eff48b9857e1_PermissionGroup
                - cell "1" [ref=e298]:
                  - paragraph [ref=e299]: "1"
              - row "アイテムを選択する TEST_権限検証_20260620 1" [ref=e300]:
                - cell "アイテムを選択する" [ref=e301]:
                  - generic [ref=e303]:
                    - generic [ref=e305]
                    - generic [ref=e308]: アイテムを選択する
                - cell "TEST_権限検証_20260620" [ref=e309]:
                  - link "TEST_権限検証_20260620" [ref=e310] [cursor=pointer]:
                    - /url: /admin/settings/permission_groups/ced25bd4-f743-5b58-a17a-0dad097bd704_PermissionGroup
                - cell "1" [ref=e311]:
                  - paragraph [ref=e312]: "1"
              - row "アイテムを選択する 特権管理者 76" [ref=e313]:
                - cell "アイテムを選択する" [ref=e314]:
                  - generic [ref=e316]:
                    - generic [ref=e318]
                    - generic [ref=e321]: アイテムを選択する
                - cell "特権管理者" [ref=e322]:
                  - link "特権管理者" [ref=e323] [cursor=pointer]:
                    - /url: /admin/settings/permission_groups/434b6285-7690-535c-9adb-9899e62b9c01_PermissionGroup
                - cell "76" [ref=e324]:
                  - paragraph [ref=e325]: "76"
          - navigation "ページネーション" [ref=e329]:
            - generic [ref=e332]:
              - generic [ref=e333]:
                - button "前へ" [disabled]:
                  - generic:
  ...
  - generic:
    - generic:
      - generic:
        - generic:
          - generic:
            - dialog "権限グループを削除しますか？" [active]:
              - generic [ref=e335]:
                - generic [ref=e337]:
                  - heading "権限グループを削除しますか？" [level=2] [ref=e339]
                  - button "閉じる" [ref=e340] [cursor=pointer]:
                    - img [ref=e343]
                - paragraph [ref=e348]: 選択された1件の権限グループを削除します。この処理は巻き戻すことができません。
                - generic [ref=e352]:
                  - button "キャンセル" [ref=e353] [cursor=pointer]:
                    - generic [ref=e354]: キャンセル
                  - button "削除する" [ref=e355] [cursor=pointer]:
                    - generic [ref=e356]: 削除する
  - alert [ref=e10]