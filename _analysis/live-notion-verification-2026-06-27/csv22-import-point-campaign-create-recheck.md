  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: キャンペーン対象商品をCSVでインポートする。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/csv_import/csv_import_operation_point_campaign_order_rule_point_value_product_variants
              - img [ref=e235]
            - heading "キャンペーン対象商品をCSVでインポートする" [level=1] [ref=e239]
        - generic [ref=e241]:
          - generic [ref=e243]:
            - generic [ref=e247]:
              - generic [ref=e250]: ポイントキャンペーン
              - generic [ref=e251]:
                - textbox "ポイントキャンペーン" [ref=e254]:
                  - /placeholder: 選択してください
                - button "検索" [ref=e256] [cursor=pointer]
            - generic [ref=e261]:
              - generic [ref=e264]: ファイルをアップロード
              - generic [ref=e265]:
                - button "ファイルをアップロード" [ref=e267]
                - generic [ref=e271]
          - button "保存する" [ref=e279] [cursor=pointer]:
            - generic [ref=e280]: 保存する
