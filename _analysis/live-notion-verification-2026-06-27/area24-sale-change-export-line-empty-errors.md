  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e296]:
        - generic [ref=e297]:
          - status:
            - paragraph [ref=e298]: 売上実績（明細軸）をCSVでエクスポートする。このページの準備が整いました
          - generic [ref=e300]:
            - link [ref=e303] [cursor=pointer]:
              - /url: /admin/csv_export/csv_export_operation_sale_change_line_items
              - img [ref=e306]
            - heading "売上実績（明細軸）をCSVでエクスポートする" [level=1] [ref=e310]
        - generic [ref=e312]:
          - generic [ref=e316]:
            - generic [ref=e318]:
              - generic [ref=e321]: テナント*
              - generic [ref=e322]:
                - combobox "テナント*" [invalid] [ref=e323]:
                ...
                - generic [ref=e324]:
                  - generic [ref=e325]: 選択してください
                  - img [ref=e328]
              - generic [ref=e362]:
                - img [ref=e365]
                - generic [ref=e369]: テナントを選択してください
              - generic [ref=e332]: エクスポートするテナントを選択してください
            - group [ref=e333]:
              - generic [ref=e334]:
                - generic [ref=e336]:
                  - generic [ref=e339]: 開始日時*
                  - textbox "開始日時*" [invalid] [ref=e343]
                  - generic [ref=e371]:
                    - img [ref=e374]
                    - generic [ref=e378]: 開始日時を入力してください
                  - generic [ref=e344]: 絞り込みを開始する日時を入力してください
                - generic [ref=e346]:
                  - generic [ref=e349]: 終了日時*
                  - textbox "終了日時*" [invalid] [ref=e353]
                  - generic [ref=e380]:
                    - img [ref=e383]
                    - generic [ref=e387]: 終了日時を入力してください
                  - generic [ref=e354]: 絞り込みを終了する日時を入力してください
          - button "エクスポートを開始する" [ref=e359] [cursor=pointer]:
            - generic [ref=e360]: エクスポートを開始する
