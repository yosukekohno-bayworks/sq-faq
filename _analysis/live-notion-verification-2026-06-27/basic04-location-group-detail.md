  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e310]:
        - generic [ref=e311]:
          - status:
            - paragraph [ref=e312]: ロケーショングループ。このページの準備が整いました
          - generic [ref=e314]:
            - link [ref=e317] [cursor=pointer]:
              - /url: /admin/settings/location_groups
              - img [ref=e320]
            - generic [ref=e322]:
              - heading "ロケーショングループ" [level=1] [ref=e324]
              - paragraph [ref=e326]: TEST_FAQ_20260624_LG_171810
        - generic [ref=e328]:
          - generic [ref=e330]:
            - generic [ref=e333]:
              - generic [ref=e336]: グループ名*
              - textbox "グループ名*" [ref=e340]:
                - /placeholder: 関東全店
                - text: TEST_FAQ_20260624_LG_171810
            - generic [ref=e342]:
              - generic [ref=e344]:
                - heading "ロケーション" [level=2] [ref=e345]
                - generic [ref=e346]:
                  - generic [ref=e347]:
                    - paragraph [ref=e348]: 含まれるロケーション
                    - paragraph [ref=e349]: "1"
                  - link "編集する" [ref=e350] [cursor=pointer]:
                    - /url: /admin/settings/location_groups/2a478a97-ff26-5ca0-8a8a-17124887d090_LocationGroup/locations
                    - generic [ref=e351]: 編集する
              - separator [ref=e352]
              - generic [ref=e354]:
                - generic [ref=e356]:
                  - checkbox "このグループに新しいロケーションを自動的に含める" [disabled] [ref=e357]
                  - generic:
                    - img
                - generic [ref=e359]: このグループに新しいロケーションを自動的に含める
          - generic [ref=e363]:
            - generic [ref=e364]:
              - generic [ref=e365]:
                - heading "デフォルトのロケーション" [level=2] [ref=e366]
                - img [ref=e369]
              - button [ref=e373] [cursor=pointer]:
                - img [ref=e376]
            - link "ユニクロ物流倉庫" [ref=e379] [cursor=pointer]:
              - /url: /admin/settings/locations/8b7c4983-7e88-549c-b23a-6fafc2c4d52c_Location
              - generic [ref=e380]: ユニクロ物流倉庫
          - generic [ref=e384]:
