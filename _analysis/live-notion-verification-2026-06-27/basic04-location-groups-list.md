  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: ロケーショングループ。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/settings
              - img [ref=e235]
            - heading "ロケーショングループ" [level=1] [ref=e239]
            - link "グループを作成" [ref=e243] [cursor=pointer]:
              - /url: /admin/settings/location_groups/create
              - img [ref=e246]
              - generic [ref=e248]: グループを作成
        - generic [ref=e251]:
          - generic [ref=e253]:
            - tablist [ref=e258]:
              - tab "すべて" [selected] [ref=e259] [cursor=pointer]:
                - generic [ref=e261]: すべて
            - separator [ref=e262]
            - generic [ref=e264]:
              - table [ref=e266]:
                - rowgroup [ref=e267]:
                  - row "グループ名 デフォルト ロケーション" [ref=e268]:
                    - columnheader "グループ名" [ref=e269]
                    - columnheader "デフォルト" [ref=e271]
                    - columnheader "ロケーション" [ref=e273]
                - rowgroup [ref=e275]:
                  - row "TEST_FAQ_20260624_LG_171810 ユニクロ物流倉庫 1個のロケーション" [ref=e276] [cursor=pointer]:
                    - cell "TEST_FAQ_20260624_LG_171810" [ref=e277]
                    - cell "ユニクロ物流倉庫" [ref=e279]
                    - cell "1個のロケーション" [ref=e281]
                  - row "ユニクログループ ユニクロ - 銀座店 3個のロケーション" [ref=e283] [cursor=pointer]:
                    - cell "ユニクログループ" [ref=e284]
                    - cell "ユニクロ - 銀座店" [ref=e286]
                    - cell "3個のロケーション" [ref=e288]
                  - row "GU グループ GU 銀座店 2個のロケーション" [ref=e290] [cursor=pointer]:
                    - cell "GU グループ" [ref=e291]
                    - cell "GU 銀座店" [ref=e293]
                    - cell "2個のロケーション" [ref=e295]
              - navigation "ページネーション" [ref=e300]:
                - generic [ref=e303]:
                  - generic [ref=e304]:
                    - button "前へ" [disabled]
                  - generic [ref=e305]:
                    - button "次へ" [disabled]
          - paragraph [ref=e307]:
            - button "ロケーショングループ" [ref=e308] [cursor=pointer]:
              - generic [ref=e309]: ロケーショングループ
            - text: についてもっと詳しくみる
