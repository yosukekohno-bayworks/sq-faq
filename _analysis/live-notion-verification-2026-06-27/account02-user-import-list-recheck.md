  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: 管理ユーザーをCSVでインポートする。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/csv_import
              - img [ref=e235]
            - heading "管理ユーザーをCSVでインポートする" [level=1] [ref=e239]
            - generic [ref=e240]:
              - link "テンプレート" [ref=e245] [cursor=pointer]:
                - /url: https://docs.google.com/spreadsheets/d/1PtOHCKHWbChZKMdEVCkMl7LXPnCSJWxsetN7rQyyKDE
                - generic [ref=e246]: テンプレート
              - link "新規インポート" [ref=e249] [cursor=pointer]:
                - /url: /admin/csv_import/csv_import_operation_users/create
                - img [ref=e252]
