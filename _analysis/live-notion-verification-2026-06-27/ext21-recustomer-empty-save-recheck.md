  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: アカウントを接続する。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/recustomer_integrations
              - img [ref=e235]
            - heading "アカウントを接続する" [level=1] [ref=e239]
        - generic [ref=e241]:
          - generic [ref=e245]:
            - generic [ref=e247]:
              - generic [ref=e250]: ストアID*
              - textbox "ストアID*" [invalid] [ref=e254]
              - generic [ref=e271]:
                - img [ref=e274]
                - generic [ref=e278]: ストアIDを入力してください
            - generic [ref=e256]:
              - generic [ref=e259]: シークレット*
              - textbox "シークレット*" [invalid] [ref=e263]
              - generic [ref=e280]:
                - img [ref=e283]
                - generic [ref=e287]: シークレットを入力してください
          - button "保存する" [ref=e268] [cursor=pointer]:
            - generic [ref=e269]: 保存する
