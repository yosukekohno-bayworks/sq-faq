  ...
  - generic [ref=e11]:
    ...
    - main [ref=e245]:
      - generic [ref=e248]:
        - generic [ref=e249]:
          - status:
            - paragraph [ref=e250]: TEST_FAQ_注文ポイント付与ルール。このページの準備が整いました
          - generic [ref=e252]:
            - link [ref=e255] [cursor=pointer]:
              - /url: /admin/point_calculation_rules/4d73fe29-07c9-5370-80a2-61c3ad3aadfa_PointCalculationRule
              - img [ref=e258]
            - generic [ref=e260]:
              - heading "TEST_FAQ_注文ポイント付与ルール" [level=1] [ref=e262]
              - paragraph [ref=e264]: 0件のテナントで利用
        - generic [ref=e268]:
          - tablist [ref=e274]:
            - link "基本設定" [ref=e275] [cursor=pointer]:
              - /url: /admin/point_calculation_rules/4d73fe29-07c9-5370-80a2-61c3ad3aadfa_PointCalculationRule
              - generic [ref=e277]: 基本設定
            - link "会員ランク倍率" [ref=e278] [cursor=pointer]:
              - /url: /admin/point_calculation_rules/4d73fe29-07c9-5370-80a2-61c3ad3aadfa_PointCalculationRule/rank_multipliers
              - generic [ref=e280]: 会員ランク倍率
            - tab "商品倍率" [selected] [ref=e281] [cursor=pointer]:
              - generic [ref=e283]: 商品倍率
          - generic [ref=e285]:
            - generic [ref=e287]:
              - heading "商品倍率" [level=2] [ref=e288]
              - button "追加する" [ref=e289] [cursor=pointer]:
                - img [ref=e292]
                - generic [ref=e294]: 追加する
            - separator [ref=e295]
            - generic [ref=e297]:
              - generic [ref=e299]:
                - img "空の検索結果" [ref=e301]
                - paragraph [ref=e303]: アイテムが見つかりませんでした
                - paragraph [ref=e306]: 絞り込みや検索ワードを変更してみてください
              - navigation "ページネーション" [ref=e308]:
                - generic [ref=e311]:
                  - generic [ref=e312]:
                    - button "前へ" [disabled]:
                      - generic:
  ...
  - generic:
    - generic:
      - generic:
        - generic:
          - generic:
            - dialog "商品倍率を追加する" [active]:
              - generic [ref=e314]:
                - generic [ref=e316]:
                  - heading "商品倍率を追加する" [level=2] [ref=e318]
                ...
                - generic [ref=e327]:
                  - generic [ref=e329]:
                    ...
                    - generic [ref=e333]:
                      ...
                      - button "選択" [ref=e338] [cursor=pointer]:
                        - generic [ref=e339]: 選択
                  - generic [ref=e341]:
                    - generic [ref=e344]: 倍率*
                    - generic [ref=e347]:
                      - spinbutton "倍率* 倍" [ref=e348]
                      - generic [ref=e349]: 倍
                - generic [ref=e353]:
                  - button "キャンセル" [ref=e354] [cursor=pointer]:
                    - generic [ref=e355]: キャンセル
                  - button "追加する" [ref=e356] [cursor=pointer]:
                    - generic [ref=e357]: 追加する
  - alert [ref=e10]