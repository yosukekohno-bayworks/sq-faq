              ...
              - rowgroup [ref=e836]:
                - row "アイテムを選択する TEST_META_SHORT_20260627 abc.def 単一行のテキスト 編集可 0個の商品" [ref=e837] [cursor=pointer]:
                  ...
                  - cell "単一行のテキスト" [ref=e850]:
                    - paragraph [ref=e851]: 単一行のテキスト
                  - cell "編集可" [ref=e852]:
                    - paragraph [ref=e853]: 編集可
                  - cell "0個の商品" [ref=e854]:
                    - paragraph [ref=e855]: 0個の商品
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e806]:
        - button "Close toast" [ref=e807] [cursor=pointer]:
          - img [ref=e808]
        - img [ref=e812]
        - generic [ref=e815]: メタフィールドの定義を作成しました
  - alert [ref=e10]