  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e243]:
        - generic [ref=e244]:
          - status:
            - paragraph [ref=e245]: 翻訳。このページの準備が整いました
          - generic [ref=e247]:
            - link [ref=e250] [cursor=pointer]:
              - /url: /admin/settings
              - img [ref=e253]
            - generic [ref=e256]:
              - heading "翻訳" [level=1] [ref=e257]
              - button "選択してください" [expanded] [ref=e260] [cursor=pointer]:
                - generic [ref=e261]: 選択してください
                - img [ref=e264]
                - menu [ref=e321]:
                  - menuitem "TEST_FAQ_英語翻訳ルール" [ref=e323]
                  - menuitem "TEST_FAQ_翻訳ルール_英語" [ref=e329]
                  - menuitem "Test_中国語" [ref=e335]
            - link "ルールを管理する" [ref=e271] [cursor=pointer]:
              - /url: /admin/settings/translation/translation_rules
              - generic [ref=e272]: ルールを管理する
        - generic [ref=e274]:
          - alert [ref=e276]:
            - generic [ref=e281]:
              - img [ref=e284]
              - heading "未選択：翻訳ルールを選択するとリソースを選択できます" [level=2] [ref=e288]
          - generic [ref=e291]:
