      ...
      - generic [ref=e225]:
        ...
        - generic [ref=e255]:
          - table [ref=e257]:
              ...
              - row "すべてのアイテムを選択する 名前 権限数" [ref=e259]:
                - columnheader "すべてのアイテムを選択する" [ref=e260]:
                  - generic [ref=e262] [cursor=pointer]:
                    - generic [ref=e264]:
                      - checkbox "すべてのアイテムを選択する" [ref=e265]
                      - generic:
                        - img
            ...
            - rowgroup [ref=e272]:
              - row "アイテムを選択する TEST_権限検証_20260620 1" [ref=e273]:
                - cell "アイテムを選択する" [ref=e274]:
                  - generic [ref=e276]:
                    - generic [ref=e278]:
                      - checkbox "アイテムを選択する" [disabled] [ref=e279]
                      - generic:
                        - img
                    - generic [ref=e281]: アイテムを選択する
                - cell "TEST_権限検証_20260620" [ref=e282]:
                  - link "TEST_権限検証_20260620" [ref=e283] [cursor=pointer]:
                    - /url: /admin/settings/permission_groups/ced25bd4-f743-5b58-a17a-0dad097bd704_PermissionGroup
                - cell "1" [ref=e284]:
                  - paragraph [ref=e285]: "1"
              - row "アイテムを選択する 特権管理者 76" [ref=e286]:
                - cell "アイテムを選択する" [ref=e287]:
                  - generic [ref=e289]:
                    - generic [ref=e291]:
                      - checkbox "アイテムを選択する" [disabled] [ref=e292]
                      - generic:
                        - img
                    - generic [ref=e294]: アイテムを選択する
                - cell "特権管理者" [ref=e295]:
                  - link "特権管理者" [ref=e296] [cursor=pointer]:
                    - /url: /admin/settings/permission_groups/434b6285-7690-535c-9adb-9899e62b9c01_PermissionGroup
                - cell "76" [ref=e297]:
                  - paragraph [ref=e298]: "76"
          - navigation "ページネーション" [ref=e302]:
            - generic [ref=e305]:
              - generic [ref=e306]:
                - button "前へ" [disabled]:
                  - generic:
