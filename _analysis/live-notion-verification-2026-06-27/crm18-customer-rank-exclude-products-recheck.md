  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: 除外商品。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              ...
              - img [ref=e235]
            - heading "除外商品" [level=1] [ref=e239]
            - link "除外商品を追加する" [ref=e243] [cursor=pointer]:
              - /url: /admin/customer_rank_calculation_rules/37f5da19-1289-5ff2-99ac-1b39ed8dfeaa_CustomerRankCalculationRule/exclude_products/create
              - generic [ref=e244]: 除外商品を追加する
        - generic [ref=e251]:
          - table [ref=e253]:
            - rowgroup [ref=e254]:
              - row "すべてのアイテムを選択する 商品 商品コード" [ref=e255]:
                - columnheader "すべてのアイテムを選択する" [ref=e256]:
                  - generic [ref=e258] [cursor=pointer]:
                    - generic [ref=e260]
                    - generic [ref=e263]: すべてのアイテムを選択する
                - columnheader "商品" [ref=e264]:
                  - generic [ref=e265]: 商品
                - columnheader "商品コード" [ref=e266]:
                  - generic [ref=e267]: 商品コード
            - rowgroup [ref=e268]:
              - row "アイテムを選択する product thumbnail オーバーサイズスウェットシャツ 486125" [ref=e269] [cursor=pointer]:
                - cell "アイテムを選択する" [ref=e270]:
                  - generic [ref=e272]:
                    - generic [ref=e274]
                    - generic [ref=e277]: アイテムを選択する
                - cell "product thumbnail オーバーサイズスウェットシャツ" [ref=e278]:
                  - generic [ref=e279]:
                    - img "product thumbnail" [ref=e281]
                    - paragraph [ref=e282]: オーバーサイズスウェットシャツ
                - cell "486125" [ref=e283]:
                  - paragraph [ref=e284]: "486125"
          - navigation "ページネーション" [ref=e288]:
            - generic [ref=e291]:
              - generic [ref=e292]:
                - button "前へ" [disabled]:
                  - generic:
