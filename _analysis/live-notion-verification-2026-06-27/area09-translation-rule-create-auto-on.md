  ...
  - generic [ref=e11]:
    ...
    - main [ref=e221]:
      - generic [ref=e369]:
        - generic [ref=e370]:
          - status:
            - paragraph [ref=e371]: 翻訳ルールを作成する。このページの準備が整いました
          - generic [ref=e373]:
            - link [ref=e376] [cursor=pointer]:
              - /url: /admin/settings/translation/translation_rules
              - img [ref=e379]
            - heading "翻訳ルールを作成する" [level=1] [ref=e383]
        - generic [ref=e384]:
          - generic [ref=e387]:
            - generic [ref=e390]:
              - generic [ref=e392]:
                - generic [ref=e395]: 名前*
                - textbox "名前*" [invalid] [ref=e399]
                - generic [ref=e431]:
                  - img [ref=e434]
                  - generic [ref=e438]: 名前を入力してください
              - generic [ref=e401]:
                - generic [ref=e404]: 言語*
                - generic [ref=e405]:
                  - combobox "言語*" [invalid] [ref=e406]:
                    ...
                    - option "タイ語"
                  - generic [ref=e407]:
                    - generic [ref=e408]: 選択してください
                    - img [ref=e411]
                - generic [ref=e440]:
                  - img [ref=e443]
                  - generic [ref=e447]: 言語を選択してください
            - generic [ref=e417]:
              - heading "各種設定" [level=2] [ref=e418]
              - generic [ref=e419] [cursor=pointer]:
                - generic [ref=e421]:
                  - checkbox "翻訳データを自動で作成する" [checked] [active] [ref=e422]
                  - generic:
                    - img
                - generic [ref=e424]: 翻訳データを自動で作成する
          - button "保存する" [ref=e428] [cursor=pointer]:
            - generic [ref=e429]: 保存する
