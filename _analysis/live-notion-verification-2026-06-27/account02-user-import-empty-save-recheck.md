  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        ...
        - generic [ref=e241]:
          - generic [ref=e245]:
            - heading "CSVファイル" [level=3] [ref=e246]
            - generic [ref=e248]:
              - generic [ref=e251]: ファイルをアップロード
              - generic [ref=e252]:
                - button "ファイルをアップロード" [ref=e254]
                - generic [ref=e258]:
                  - button "ファイルを選択する" [ref=e259] [cursor=pointer]
                  - paragraph [ref=e261]: もしくはドラッグ&ドロップでアップロードすることができます
          - button "保存する" [ref=e266] [cursor=pointer]:
            - generic [ref=e267]: 保存する
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e268]:
        - button "Close toast" [ref=e269] [cursor=pointer]:
          - img [ref=e270]
        - img [ref=e274]
        - generic [ref=e277]: ファイルを選択してください
  - alert [ref=e10]