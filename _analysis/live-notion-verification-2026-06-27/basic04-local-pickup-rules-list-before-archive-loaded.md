  ...
  - generic [ref=e11]:
    ...
    - main [ref=e229]:
      - generic [ref=e269]:
        - generic [ref=e270]:
          - status:
            - paragraph [ref=e271]: 店舗受取。このページの準備が整いました
          - generic [ref=e273]:
            - heading "店舗受取" [level=1] [ref=e276]
            - link "追加する" [ref=e280] [cursor=pointer]:
              - /url: /admin/local_pickup_retail_location_rules/create
              - generic [ref=e281]: 追加する
        - generic [ref=e288]:
          - generic [ref=e290]:
            - img "空の検索結果" [ref=e292]
            - paragraph [ref=e294]: アイテムが見つかりませんでした
            - paragraph [ref=e297]: 絞り込みや検索ワードを変更してみてください
          - navigation "ページネーション" [ref=e299]:
            - generic [ref=e302]:
              - generic [ref=e303]:
                - button "前へ" [disabled]
              - generic [ref=e304]:
