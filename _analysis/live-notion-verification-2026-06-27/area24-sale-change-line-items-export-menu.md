  ...
  - generic [ref=e11]:
        ...
        - generic [ref=e38]:
          - list [ref=e39]:
            ...
            - listitem [ref=e108]:
              ...
              - list [ref=e119]:
                - listitem [ref=e120]:
                  - link "売上実績" [ref=e123] [cursor=pointer]:
                    - /url: /admin/sale_change_line_items
                    - generic [ref=e124]: 売上実績
            - listitem [ref=e125]:
              - generic [ref=e126]:
                - generic:
                  - link "分析":
    ...
    - main [ref=e230]:
      - generic [ref=e233]:
        - generic [ref=e234]:
          - status:
            - paragraph [ref=e235]: 売上実績。このページの準備が整いました
          - generic [ref=e237]:
            - heading "売上実績" [level=1] [ref=e240]
            - generic [ref=e241]:
              - button "エクスポート 注文軸 明細軸" [expanded] [ref=e283] [cursor=pointer]:
                - img [ref=e250]
                - generic [ref=e253]: エクスポート
                - img [ref=e256]
                - list [ref=e288]:
                  - listitem [ref=e289]:
                    - link "注文軸" [ref=e291]:
                  ...
                  - listitem [ref=e296]:
                    - link "明細軸" [ref=e298]:
                      - /url: /admin/csv_export/csv_export_operation_sale_change_line_items
              - generic [ref=e259]:
                - generic:
                  - generic:
                    - generic
        ...
        - generic [ref=e266]:
          - generic [ref=e268]:
            - img "空の検索結果" [ref=e270]
            - paragraph [ref=e272]: アイテムが見つかりませんでした
            - paragraph [ref=e275]: 絞り込みや検索ワードを変更してみてください
          - navigation "ページネーション" [ref=e277]:
            - generic [ref=e280]:
              - generic [ref=e281]:
                - button "前へ" [disabled]:
                  - generic:
