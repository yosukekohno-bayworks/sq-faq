  ...
  - generic [ref=e11]:
    ...
    - main [ref=e222]:
      - generic [ref=e225]:
        - generic [ref=e226]:
          - status:
            - paragraph [ref=e227]: ポイントをCSVで一括加算する。このページの準備が整いました
          - generic [ref=e229]:
            - link [ref=e232] [cursor=pointer]:
              - /url: /admin/csv_import/csv_import_operation_point_pluses
              - img [ref=e235]
            - heading "ポイントをCSVで一括加算する" [level=1] [ref=e239]
        - generic [ref=e241]:
          - generic [ref=e245]:
            - generic [ref=e247]:
              - generic [ref=e250]: テナント
              - generic [ref=e251]:
                - combobox "テナント" [invalid] [ref=e252]
                - generic [ref=e253]
              - generic [ref=e299]:
                - img [ref=e302]
                - generic [ref=e306]: テナントを選択してください
            - generic [ref=e262]:
              - generic [ref=e265]: 顧客IDの種別
              - generic [ref=e266]:
                - combobox "顧客IDの種別" [invalid] [ref=e267]
                - generic [ref=e268]
              - generic [ref=e308]:
                - img [ref=e311]
                - generic [ref=e315]: 顧客IDの種別を選択してください
            - generic [ref=e278]:
              - generic [ref=e281]: ファイルをアップロード
              - generic [ref=e282]:
                - button "ファイルをアップロード" [ref=e284]
                - generic [ref=e288]
          - button "保存する" [ref=e296] [cursor=pointer]:
            - generic [ref=e297]: 保存する
