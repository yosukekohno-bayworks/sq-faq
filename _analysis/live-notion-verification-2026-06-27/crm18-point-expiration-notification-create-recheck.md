  ...
  - generic [ref=e11]:
    ...
    - main [ref=e245]:
      - generic [ref=e330]:
        - generic [ref=e331]:
          - status:
            - paragraph [ref=e332]: ポイント失効通知ルールを作成する。このページの準備が整いました
          - generic [ref=e334]:
            - link [ref=e337] [cursor=pointer]:
              - /url: /admin/point_expiration_notification_rule
              - img [ref=e340]
            - heading "ポイント失効通知ルールを作成する" [level=1] [ref=e344]
        - generic [ref=e346]:
          - generic [ref=e350]:
            - generic [ref=e352]:
              - generic [ref=e355]: タイトル
              - textbox "タイトル" [ref=e359]:
                - /placeholder: ポイント失効通知
            - generic [ref=e361]:
              - generic [ref=e364]: 通知予定日
              - generic [ref=e367]:
                - generic [ref=e368]: 失効日の
                - spinbutton "通知予定日 失効日の 日前" [ref=e369]
                - generic [ref=e370]: 日前
          - button "保存する" [ref=e375] [cursor=pointer]:
            - generic [ref=e376]: 保存する
